package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_7:String = "debug";
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc6_[const_7] = "Memory usage: " + Math.round(0 / (1024 * 1024)) + " MB";
            _loc5_.data = _loc6_;
      ...
      private function onPreLoadingCompleted(param1:Event) : void
      {
         ...
         catch(error:Error)
         {
            ...
            reportCrash("Failed to finalize main swf preloading: " + error.message,const_18,error);
         }
      }
