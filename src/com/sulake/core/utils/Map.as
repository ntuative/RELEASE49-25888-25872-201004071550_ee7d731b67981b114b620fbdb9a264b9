package com.sulake.core.utils
{
   ...
   public class Map extends Proxy implements IDisposable
   {
      ...
      {
         var _loc2_:Object = var_118[param1];
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      public function unshift(param1:*, param2:*) : Boolean
      {
         ...
         var_118[param1] = param2;
         var_28.unshift(param2);
         var_211.unshift(param1);
         ++_length;
         return true;
      }
      ...
      override flash_proxy function getProperty(param1:*) : *
      {
         ...
         return var_118[param1];
      }
      
      public function reset() : void
      {
         var _loc1_:* = null;
         for(_loc1_ in var_118)
         {
            delete var_118[_loc1_];
         }
         _length = 0;
         var_28 = [];
         var_211 = [];
      ...
      override flash_proxy function setProperty(param1:*, param2:*) : void
      {
         ...
         var_118[param1] = param2;
         var _loc3_:int = var_211.indexOf(param1);
         if(_loc3_ == -1)
         {
            var_28[_length] = param2;
            var_211[_length] = param1;
            ++_length;
         }
         else
         {
