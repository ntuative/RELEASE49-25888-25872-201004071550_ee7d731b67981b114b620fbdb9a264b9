package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1179:int = 10000;
      ...
      private var var_685:IEncryption;
      ...
      private var var_574:IProtocol;
      
      private var var_830:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         var_830 = new MessageClassManager();
         var_74 = new Socket();
         var_348 = new Timer(const_1179,1);
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_830.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            return false;
         }
         var _loc5_:ByteArray = var_574.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(var_349)
         {
         ...
         if(var_685 != null)
         {
            _loc3_ = var_685.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_347.writeByte(var_74.readUnsignedByte());
         }
      }
      ...
      {
         var_830.registerMessages(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_574.getMessages(var_347,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            _loc7_ = var_830.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_685 + "\n");
      }
   }
}
