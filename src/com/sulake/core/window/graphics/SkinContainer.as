package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private var var_743:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_743 = new Dictionary();
         var_744 = new Dictionary();
         var_1565 = new Dictionary();
         var_2180 = new Dictionary();
         TypeCodeTable.fillTables(var_1565,var_2180);
         var_1320 = new Dictionary();
         var_2181 = new Dictionary();
         StateCodeTable.fillTables(var_1320,var_2181);
         var_530 = new Dictionary();
         var_530["skin"] = BitmapSkinRenderer;
         var_530["bitmap"] = BitmapDataRenderer;
         var_530["fill"] = FillSkinRenderer;
         var_530["text"] = TextSkinRenderer;
         var_530["shape"] = ShapeSkinRenderer;
         var_530["unknown"] = SkinRenderer;
         var_530["null"] = NullSkinRenderer;
         if(var_380 == null)
         {
            var_380 = new Array();
            var_380.push(WindowState.const_63);
            var_380.push(WindowState.const_68);
            var_380.push(WindowState.const_96);
            var_380.push(WindowState.WINDOW_STATE_SELECTED);
            var_380.push(WindowState.const_79);
            var_380.push(WindowState.const_74);
            var_380.push(WindowState.const_97);
            var_380.push(WindowState.const_89);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1320)
         {
            _loc3_.push(var_1320[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1565[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_744[param1];
      ...
      {
         var _loc3_:Array = var_743[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_743[param1] = new Array(SkinContainer.const_785);
         }
         var_743[param1][param2] = param3;
         if(true)
         {
            var_744[param1] = new Array(SkinContainer.const_785);
         }
         var_744[param1][param2] = param4;
      }
