package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_998:uint = 256;
      ...
      public static const const_1513:uint = 128;
      
      public static const const_1522:uint = 64;
      
      public static const const_737:uint = 4;
      
      public static const const_1395:uint = 0;
      
      public static const const_1357:uint = 16;
      
      public static const const_625:uint = 1;
      
      public static const const_1347:uint = 8;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_926:
               ...
               break;
            case GraphicContext.const_1347:
               setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1357:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_737:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_998:
               break;
            case GraphicContext.const_1395:
               break;
            default:
         ...
         if(var_637)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1609,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1609,16777215);
                  }
                  var_379 += bitmap.width * bitmap.height * 4;
               }
