package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      {
         var _loc3_:ISkinTemplate = var_324[param2];
         if(_loc3_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         for(_loc1_ in var_324)
         {
            ISkinTemplate(var_324[_loc1_]).dispose();
            delete var_324[_loc1_];
         }
         var_324 = null;
         var_323 = null;
      }
