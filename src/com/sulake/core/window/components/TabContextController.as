package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_944:ITabSelectorWindow;
      
      private var var_813:Boolean = false;
      
      protected var var_1610:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1610 == null)
         {
            var_1610 = findChildByTag(TabContextController.TAB_CONTEXT_CONTENT_TAG) as IWindowContainer;
         }
         return var_1610;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_944 == null)
         {
            var_944 = findChildByTag(TabContextController.TAB_CONTEXT_SELECTOR_TAG) as ITabSelectorWindow;
            if(var_944 != null)
            {
               var_944.procedure = selectorEventProc;
            }
         }
         return var_944;
      }
      ...
      {
         return !!var_813 ? selector.iterator : null;
      }
