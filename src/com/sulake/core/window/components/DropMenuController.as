package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         {
            var_126 = context.create(name + "::submenu","",WindowType.const_426,var_78,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.const_98)
         {
            if(param2 is IDropMenuItemWindow)
            {
               ...
               {
                  selection = method_3(param2 as IDropMenuItemWindow);
               }
            }
         }
         ...
         else if(param1.type == WindowEvent.const_957)
         {
            if(param2 == var_126)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_446,var_78,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         if(var_497 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_497).setStateFlag(WindowState.WINDOW_STATE_SELECTED,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_579)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_496,getSubMenu(),subMenuEventProc);
                  var_579 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_413,this,null,true);
         update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            var_497 = param1;
            closeMenuView();
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_324,this,null));
         }
      }
      ...
      private function menuItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_51)
         {
            if(param2 is IDropMenuItemWindow)
            {
               _loc3_ = uint(method_3(param2 as IDropMenuItemWindow));
               selection = _loc3_;
            }
         }
      }
      ...
      public function method_3(param1:IDropMenuItemWindow) : int
      {
         var _loc2_:int = -1;
         ...
         if(_loc2_ == -1)
         {
            if(var_126 != null)
            {
               _loc2_ = var_126.method_3(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_579 = false;
            getTitleText().text = var_497 < var_496.length && var_497 > -1 ? "null" : caption;
         }
      }
   }
}
