package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2352:Rectangle = new Rectangle();
      ...
      protected var var_640:Number;
      
      protected var var_378:Number;
      ...
      {
         return new Rectangle(var_640 * maxScrollH,var_378 * maxScrollV,width,height);
      }
      ...
      {
         var_640 = param1;
         _field.scrollH = var_640 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_982,true));
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_640 = var_640;
         _loc1_.var_378 = var_378;
