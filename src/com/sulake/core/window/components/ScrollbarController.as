package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1124:String = "increment";
      
      private static const const_496:String = "slider_bar";
      
      private static const const_1125:String = "decrement";
      
      private static const const_793:String = "slider_track";
      ...
      protected var var_772:Number = 0.1;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_496:
      ...
      {
         return findChildByName(ScrollbarController.const_793) as WindowController;
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_496) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_929 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_929 != null)
         {
            _loc1_ = findParentByName(var_929) as IScrollableWindow;
            if(_loc1_ == null && var_8 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_8).findChildByName(var_929) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1124)
            {
               if(var_20)
               {
                  var_629 = true;
            ...
            else if(param2.name == ScrollbarController.const_1125)
            {
               if(var_20)
               {
                  var_629 = true;
            ...
            else if(param2.name == ScrollbarController.const_793)
            {
               _loc4_ = new Point();
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_496).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_903)
         {
