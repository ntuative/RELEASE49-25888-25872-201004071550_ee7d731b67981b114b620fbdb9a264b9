package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_762:String = "margin_right";
      
      private static const const_1050:String = "_SCALER";
      
      private static const const_1051:String = "_TITLE";
      
      private static const const_1052:String = "_CONTENT";
      ...
      private var var_1176:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_759,_loc3_.left,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_761,_loc3_.top,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_762,0 - _loc3_.right,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_760,0 - _loc3_.bottom,PropertyStruct.const_62,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_255);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_205);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_218);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1176 == null)
         {
            var_1176 = findChildByTag(const_1049) as IHeaderWindow;
            if(!var_1176)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1051) as ITextWindow;
            if(!_title)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_271,false);
         }
      ...
      {
         return content != null && var_1387 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_19 == null)
         {
            var_19 = findChildByTag(const_1052) as IWindowContainer;
            if(!var_19)
            {
