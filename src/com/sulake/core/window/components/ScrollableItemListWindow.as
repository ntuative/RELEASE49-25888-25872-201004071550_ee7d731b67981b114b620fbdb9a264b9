package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_801:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_336)
         {
            ...
            if(var_336)
            {
               var_336.addEventListener(WindowEvent.const_240,scrollBarEventProc);
               var_336.addEventListener(WindowEvent.const_219,scrollBarEventProc);
            }
         }
         return var_336;
      }
      ...
      override public function dispose() : void
      {
         if(var_336)
         {
            var_336.removeEventListener(WindowEvent.const_240,scrollBarEventProc);
            var_336.removeEventListener(WindowEvent.const_219,scrollBarEventProc);
            var_336 = null;
         }
         if(var_801)
         {
      ...
      {
         if(param1.type == WindowEvent.const_240)
         {
            showScrollBar();
         }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_801)
         {
            var_801 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_801;
      }
