package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1487:String = "_INCLUDE";
      
      public static const const_1025:String = "_EXCLUDE";
      
      public static const const_1605:String = "_TEMP";
      
      private static const const_1111:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1110:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1115:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_950:Dictionary;
      
      protected var var_1392:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1115 = new Dictionary();
         TypeCodeTable.fillTables(var_1114,var_1115);
         var_950 = new Dictionary();
         var_1391 = new Dictionary();
         ParamCodeTable.fillTables(var_950,var_1391);
         var_1392 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1110,"");
         return param1.replace(const_1111,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1115)
            {
               delete var_1115[_loc1_];
            }
            for(_loc1_ in var_950)
            {
               delete var_950[_loc1_];
            }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1025) == -1)
                  {
