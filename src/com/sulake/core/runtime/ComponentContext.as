   ...
   public class ComponentContext extends Component implements IContext
   {
      ...
      protected final function announceInterfaceAvailability(param1:IID, param2:Component) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            if(_loc4_ == null)
            {
               error("Interface " + param1 + " still unavailabe!",true,Core.const_1393);
            }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            if(var_374 != null)
            {
               ...
               while(_loc1_-- > 0)
               {
                  IDisposable(var_374.pop()).dispose();
               }
               var_374 = null;
            }
            if(var_243 != null)
      ...
      protected final function hasQueueForInterface(param1:IID) : Boolean
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if(getQualifiedClassName(var_374[_loc4_].identifier) == _loc2_)
            {
               return true;
            }
            _loc4_++;
      ...
      protected function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         removeLibraryLoader(_loc2_);
         error("Failed to download component resource \"" + _loc2_.url + "\"!" + "\r" + _loc3_,true,Core.const_1298);
      }
         ...
         while(i < componentList.length())
         {
            ...
            if(assetCount > 0)
            {
               ...
               while(k < assetCount)
               {
                  ...
                  {
                     error("Manifest for component " + componentString + " contains broken asset \"" + assetName + "\"!",true,Core.const_513);
                  }
                  k++;
               }
            }
            ...
            if(componentClass == null)
            {
               error("Invalid component class " + componentString + "!",true,Core.const_513);
               return false;
            }
            ...
            if(component != null)
            {
               if(assetLibrary != null)
               {
                  if(component.assets != assetLibrary)
                  {
                     ...
                     error("Component \"" + componentString + "\" did not save provided asset library!",true,Core.const_513);
                  }
               }
