package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1078:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_610:uint = 0;
      
      public static const const_805:String = "AssetLibraryReady";
      
      public static const const_1153:String = "AssetLibraryUnloaded";
      ...
      private var var_529:Boolean = true;
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_432)
         {
            _loc4_ = AssetTypeDeclaration(var_432[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in var_741)
         {
            delete var_741[_loc1_];
         }
         if(var_16 != null)
         {
            var_16.dispose();
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_528 = _loc2_.manifest.copy();
         var_361 = _loc2_.resource;
         if(var_529)
         {
            AssetLibrary.fetchLibraryContents(this,var_528,var_361);
         }
         var_318 = true;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_431[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_830,assetLoadEventHandler);
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_848,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_431[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_432.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_432[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1078.splice(var_1078.indexOf(this),1);
            --var_610;
            var_431 = null;
            var_741 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_360.length ? getAssetByName(var_360[param1]) : null;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_432)
         {
            _loc3_ = AssetTypeDeclaration(var_432[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_528.child("library");
         if(_loc2_ == null)
         {
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_431[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_360.splice(var_360.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_432[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
