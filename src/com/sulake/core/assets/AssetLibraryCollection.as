package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      private var var_641:uint = 0;
      
      protected var var_377:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_377 = new AssetLibrary("lib-" + var_641++);
         var_30.push(var_377);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return var_377.createAsset(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_377.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      {
         return var_377.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      {
         return var_377.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return var_377.setAsset(param1,param2,param3);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_377.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = false, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         var _loc4_:IAssetLibrary = new AssetLibrary("lib-" + var_641++);
         var_547.push(_loc4_);
      ...
      {
         return var_377.loadFromResource(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_377.getAssetTypeDeclarationByMimeType(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      {
         return var_377.loadFromArchive(param1,param2);
      }
