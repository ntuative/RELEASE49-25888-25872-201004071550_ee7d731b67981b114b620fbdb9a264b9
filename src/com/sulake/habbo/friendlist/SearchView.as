package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      public function fillFooter(param1:IWindowContainer) : void
      {
         ...
         var_698.addEventListener(WindowKeyboardEvent.const_134,onSearchStrInput);
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_351.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_351.showPopup(_friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_49.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_309,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      public function refreshList() : void
      {
         ...
         while(true)
         {
            ...
            else if(_loc2_ <= _loc1_.friends.length + _loc1_.others.length + 1)
            {
               ...
               refreshEntry(true,_loc2_,_loc4_.avatarFigure,_loc4_.avatarName,null,false,false,_loc4_.avatarId != _friendList.avatarId && !_friendList.searchResults.method_8(_loc4_.avatarId),_loc4_.avatarId);
            }
            else
            {
