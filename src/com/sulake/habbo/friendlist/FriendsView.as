package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_578:String = "bg";
       
      
      private var var_1909:IContainerButtonWindow;
      
      private var var_1911:IContainerButtonWindow;
      
      private var var_1908:IContainerButtonWindow;
      
      private var var_1910:IContainerButtonWindow;
      
      private var var_351:AvatarPopupCtrl;
      ...
      {
         _friendList = param1;
         var_351 = new AvatarPopupCtrl(_friendList);
      }
      ...
      {
         var_1911 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1908 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1909 = initButton("room_invite",onInviteButtonClick,param1);
         var_1910 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_578);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_351.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_351.showPopup(_friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_30)
         {
            this.var_351.closePopup();
         }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1911,isEnableMinimailButton(_loc1_));
         setEnabled(var_1908,isEnableHomeButton(_loc1_));
         setEnabled(var_1909,isEnableInviteButton(_loc1_));
         setEnabled(var_1910,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_578);
