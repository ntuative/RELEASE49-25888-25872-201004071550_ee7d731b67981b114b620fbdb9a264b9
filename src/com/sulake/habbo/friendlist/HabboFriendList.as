package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1484:OpenedToWebPopup;
      
      private var var_833:IAvatarRenderManager;
      ...
      private var var_1483:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_575:ISessionDataManager;
      
      private var var_350:FriendRequests;
      
      private var var_1896:int;
      
      var var_86:FriendCategories;
      
      private var var_1895:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_832:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1895 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_86 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1483 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_350.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_350.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_434.findTab(FriendListTab.const_88).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var_575 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_350 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_86.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_86.addCategory(new FriendCategory(FriendCategory.const_1023,getText("friendlist.friends")));
         var_86.addCategory(new FriendCategory(FriendCategory.const_456,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_86.addFriend(new Friend(_loc4_));
         }
         var_434 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_487)
         {
         ...
         getBuddyRequests();
         registerListeners();
         var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         if(var_833)
         {
            var_833.release(new IIDAvatarRenderManager());
            var_833 = null;
         }
         if(var_832)
         {
            var_832.release(new IIDHabboNotifications());
            var_832 = null;
         }
         if(var_190)
         {
         ...
         if(var_575)
         {
            var_575.release(new IIDSessionDataManager());
            var_575 = null;
         }
         super.dispose();
      }
      ...
      {
         var _loc1_:String = var_151.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_434.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1483.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_168,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_350.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function canBeAskedForAFriend(param1:int) : Boolean
      {
         ...
         return this.getFriend(param1) == null && !searchResults.method_8(param1) && categories.getFriendCount(false) < friendRequests.limit;
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_575.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_575.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_350.limit)
         {
            var_350.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_434.findTab(FriendListTab.const_88);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_833.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_350.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_434.findTab(FriendListTab.const_88);
      ...
      {
         return var_151.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1484 == null)
         {
            var_1484 = new OpenedToWebPopup(this);
         }
         var_1484.show(x,y);
      }
