package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1412:String = "messageinput";
      ...
      private var var_1148:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1148 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_923 = IWindowContainer(var_13.content.findChildByName("main_content"));
         var_282 = IWindowContainer(var_13.content.findChildByName("footer"));
         var_1148.prepare(var_923);
         var_13.procedure = onWindow;
         var_13.content.setParamFlag(HabboWindowParam.const_834,false);
         var_13.content.setParamFlag(HabboWindowParam.const_1313,true);
         var_13.header.setParamFlag(HabboWindowParam.const_701,false);
         var_13.header.setParamFlag(HabboWindowParam.const_856,true);
         var_13.content.setParamFlag(HabboWindowParam.const_701,false);
         var_13.content.setParamFlag(HabboWindowParam.const_856,true);
         var_13.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1147 = ITextWindow(var_13.findChildByName("info_text"));
         var_1147.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_13.scaler.setParamFlag(HabboWindowParam.const_701,false);
         var_13.scaler.setParamFlag(HabboWindowParam.const_834,false);
         var_13.scaler.x = 0 - var_13.scaler.width;
         var_13.scaler.y = 0 - var_13.scaler.height;
         var_1435 = var_13.height;
         var_1434 = var_13.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1435 == -1 ? 0 : int(0 - var_1435);
