package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_302:int = 100;
      ...
      {
         return Math.ceil(this.var_227.length / const_302);
      }
      ...
      {
         if(this.var_871 >= this.getPageCount())
         {
            this.var_871 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         {
            _loc4_ = var_227[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               var_227.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_871 + 1) * const_302,this.var_227.length);
      }
