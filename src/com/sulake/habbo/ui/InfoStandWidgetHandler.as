   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            ...
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_140,onFigureUpdate);
         ...
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_140,onFigureUpdate);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_610);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_298);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_879);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_914);
            ...
            case RoomObjectCategoryEnum.const_36:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_334)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_901)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_508);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_213)
               {
                  _loc13_.realName = _container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_232)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_549);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1160;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_874;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1394);
               }
               else
               {
               ...
               _loc18_ = _loc11_.sex;
               _loc19_ = _container.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_52,_loc18_);
               if(_loc19_ != null)
               {
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         if(false)
         {
            _loc5_ = _container.avatarRenderManager.createAvatarImage(param1.figure,AvatarScaleType.const_52,param1.gender);
            if(_loc5_ != null)
            {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_626.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_52);
            var_626.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_549);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_723);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_504);
         _loc1_.push(RoomWidgetFurniActionMessage.const_584);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_545);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_512);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1158);
         _loc1_.push(RoomWidgetPetCommandMessage.const_653);
         _loc1_.push(RoomWidgetPetCommandMessage.const_515);
         _loc1_.push(RoomWidgetUserActionMessage.const_612);
         _loc1_.push(RoomWidgetUserActionMessage.const_471);
         return _loc1_;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_626 != null)
         {
            _loc1_ = var_626.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_626.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_415)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_523:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_873,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_571:
               ...
               break;
            case RoomWidgetUserActionMessage.const_723:
            ...
            case RoomWidgetUserActionMessage.const_595:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_504:
            ...
            case RoomWidgetRoomTagSearchMessage.const_545:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_512:
            ...
            case RoomWidgetUserActionMessage.const_725:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_515:
