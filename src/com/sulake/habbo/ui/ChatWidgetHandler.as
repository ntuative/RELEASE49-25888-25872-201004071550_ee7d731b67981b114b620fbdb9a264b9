package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_458:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_457.length)
            {
               _loc2_ = var_457.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_457.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_645.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_340:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_457.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_645.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_541,RoomWidgetChatSelectAvatarMessage.const_573];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_541:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_137,_container.roomSession,0,"Version 25888-25872-201004071508");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_573:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_775 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_775);
            }
            if(var_458 == null)
            {
               var_459.x = 0;
               var_459.y = 0;
               var_459.z = 0;
               var_458 = _loc4_.getScreenPoint(var_459);
               var_775 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_459.x = 0;
            var_459.y = 0;
            var_459.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_459);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_458.x || _loc8_.y != var_458.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_458,_loc5_));
