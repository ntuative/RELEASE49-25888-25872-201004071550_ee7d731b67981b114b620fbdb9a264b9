package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_821:IRoomWidgetFactory = null;
      ...
      private var var_585:IAvatarRenderManager = null;
      ...
      private var var_2039:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_448,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_680,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_704 = _roomEngine.loadRoomResources(var_36.roomResources);
            if(false)
            {
               var_1261 = false;
         ...
         {
            var_1262 = !var_254.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_36.roomId,var_36.roomCategory,var_263[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_friendList && false)
         {
            ...
            _friendList.events.removeEventListener(FriendRequestEvent.const_266,processEvent);
         }
         _friendList = null;
         var_170.dispose();
         var_170 = null;
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_448,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_680,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_18 = null;
         var_821 = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_2039);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_190 != null)
         {
            var_170.toolbarSize = var_190.size;
            var_170.toolbarOrientation = var_190.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            _roomEngine.handleRoomCanvasMouseEvent(var_263[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_821.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_629:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_289,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(var_676 != null && _loc3_ == RoomObjectCategoryEnum.const_36)
               {
                  _loc7_ = var_36.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_334)
                  {
                     var_676.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_475:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_228,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_660);
            _loc13_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_564);
            _loc14_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_597);
            _loc15_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_630);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_337);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_420:
               ...
               var_171 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_335,WindowStyle.const_338,WindowParam.const_90) as IToolTipWindow;
               var_171.setParamFlag(WindowParam.const_47,false);
      ...
      {
         if(var_18 != null && var_36 != null && var_1262 && var_1261)
         {
            var_18.startSession(var_36);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_248));
         }
      }
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(_friendList)
         {
            ...
            _friendList.events.addEventListener(FriendRequestEvent.const_266,processEvent);
         }
      }
