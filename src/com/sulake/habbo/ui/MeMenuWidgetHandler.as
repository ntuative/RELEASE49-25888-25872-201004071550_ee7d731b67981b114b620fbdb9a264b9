   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(false)
         {
            ...
            _loc6_ = _container.avatarRenderManager.createAvatarImage(_loc4_,AvatarScaleType.const_52,_loc5_);
            if(_loc6_ != null)
            {
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_190 + " " + _loc7_);
            if(var_190 != null && _loc7_ != null)
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_819,HabboToolbarIconEnum.MEMENU);
               _loc9_.bitmapData = _loc7_;
               var_190.events.dispatchEvent(_loc9_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_542,onFigureUpdate);
            }
            if(false)
            {
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_542,onFigureUpdate);
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_177,onCreditBalance);
         }
         var_10 = _container.inventory;
         if(var_10 != null)
         {
            (var_10 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_816,onAvatarEffectsChanged);
            (var_10 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_924,onHabboClubSubscriptionChanged);
         }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_476:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_463));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_733);
         _loc1_.push(RoomWidgetDanceMessage.const_577);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_616);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_501);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_678);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_688);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_689);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_611);
         _loc1_.push(RoomWidgetStopEffectMessage.const_652);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1386);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_862);
         _loc1_.push(RoomWidgetToolbarMessage.const_739);
         _loc1_.push(RoomWidgetToolbarMessage.const_547);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_658);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1209);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_946);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_567);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_620);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_651);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1258);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_544);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_503);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_620:
               ...
               break;
            case RoomWidgetWaveMessage.const_733:
               if(_container != null && false)
               {
                  _container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_577:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_616:
               if(var_10 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_501:
               if(var_10 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_678:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_611:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_940)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_195,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_689:
               ...
               if(var_10 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_904:
                        _catalog.openCatalogPage(CatalogPageName.const_1363,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_981:
                        var_10.toggleInventoryPage(InventoryCategory.const_259);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1278:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_688:
            case RoomWidgetStopEffectMessage.const_652:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_567:
               ...
               break;
            case RoomWidgetToolbarMessage.const_739:
               ...
               if(var_190)
               {
                  var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_10 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
               ...
               break;
            case RoomWidgetToolbarMessage.const_547:
               ...
               if(var_190 && false)
               {
                  var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_399,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_658:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_621));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_651:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_323,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_544:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_323,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_503:
            ...
            case RoomWidgetAvatarEditorMessage.const_532:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_528));
               }
               break;
            default:
