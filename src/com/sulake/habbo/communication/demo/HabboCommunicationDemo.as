package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_427:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            ...
            case DisconnectReasonEvent.const_1143:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1233:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_1187:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2131)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_731 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_731);
            _loc2_.send(_loc4_);
      ...
      {
         var_1072 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_230);
         param1.send(new VersionCheckMessageComposer(401,var_1296,var_2130));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_427.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_427.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2129);
      ...
      {
         var_731 = _habboConfiguration.getKey("sso.ticket",null);
         var_1296 = _habboConfiguration.getKey("flash.client.url","");
         var_2130 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_175 == null)
         {
         ...
         if(var_731 != null)
         {
            var_65.mode = HabboConnectionType.const_432;
            var_65.initConnection(HabboConnectionType.const_272);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1547 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_519);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2129 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_65.mode)
         {
            case HabboConnectionType.const_432:
               _loc6_ = "";
               ...
               var_1071 = _loc4_;
               var_175.loadBannerImage(_loc7_ + "?token=" + var_1071,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_832:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1385:
               var_605 = generateRandomHexString(30);
               var_427 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_427.init(var_605);
               _loc8_ = var_427.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1071);
         ...
         var_427 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_427.init(_loc14_);
            _loc15_ = var_427.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_65.mode = HabboConnectionType.const_832;
            }
         }
         var_65.initConnection(HabboConnectionType.const_272);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_153,onConfigurationLoaded);
         }
      }
      ...
      private function method_9(param1:IID, param2:IUnknown) : void
      {
