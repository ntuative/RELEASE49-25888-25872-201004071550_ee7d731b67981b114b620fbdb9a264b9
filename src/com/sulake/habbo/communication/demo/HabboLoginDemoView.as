package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private var var_340:HabboCommunicationDemo;
      ...
      {
         var_340.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_340.shockwaveClientUrl = var_110.shockwaveClientUrl;
         var_340.ssoTicket = var_110.ticket;
         var_110.removeEventListener(SSOTicket.const_308,onParsedTicketSuccess);
         var_110.removeEventListener(SSOTicket.const_257,onParsedTicketFailure);
         var_110 = null;
      ...
      {
         var _loc1_:XmlAsset = (var_340 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_340.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_355,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_340.windowManager.buildFromXML(_loc2_) as IWindowContainer;
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_340.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_340.habboCommunication.habboWebLogin(name,password);
         var_110 = new SSOTicket(var_340.assets,_loc2_,_loc1_);
         var_110.addEventListener(SSOTicket.const_308,onParsedTicketSuccess);
         var_110.addEventListener(SSOTicket.const_257,onParsedTicketFailure);
      }
