   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.const_34)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_466));
            }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_753.loadAssetFromFile("hotel_view_banner_" + var_917,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_665));
            }
            var_624 = param2;
