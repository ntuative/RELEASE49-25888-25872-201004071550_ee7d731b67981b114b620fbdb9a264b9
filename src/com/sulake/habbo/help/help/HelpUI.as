package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_433:IWindowContainer;
      ...
      private var var_2212:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","25888-25872-201004071508");
         var_190 = param5;
         var_100 = new Map();
         var_100.add(HabboHelpViewEnum.const_1356,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_149,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_462,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_251,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_227,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_582,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_295,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_668,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_229,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_100.add(HabboHelpViewEnum.const_851,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_734,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1577 = 0 - _loc3_.width;
         var_1576 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_280 == HabboHelpViewEnum.const_149 || false)
         {
            return;
         }
         if(var_433 == null)
         {
            ...
            var_433 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_433 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_433 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_433 as IWindow);
      ...
      {
         return var_100.getValue(var_280);
      }
      ...
      {
         var_2211 = param1;
         var _loc2_:IHelpViewController = var_100.getValue(HabboHelpViewEnum.const_149) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_229:
               showUI(HabboHelpViewEnum.const_229);
               break;
            case CallForHelpResultEnum.const_800:
               showUI(HabboHelpViewEnum.const_851);
               break;
            case CallForHelpResultEnum.const_817:
      ...
      {
         var _loc3_:* = null;
         if(var_280 == HabboHelpViewEnum.const_149)
         {
            return;
         }
         if(true)
         {
            ...
            var_621.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_621.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_433.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_621[1],var_621[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_621[0],var_621[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1576;
         _window.width = _loc1_.width + var_1577;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_190 != null)
            {
               var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_21.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_727));
      }
