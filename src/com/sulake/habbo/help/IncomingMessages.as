package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_21.tellUI(HabboHelpViewEnum.const_227,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_21.tellUI(HabboHelpViewEnum.const_251,_loc6_);
      }
      
      private function method_5(param1:int) : String
      {
         if(param1 == 1)
         {
            return "useless";
      ...
      private function onIssueClose(param1:IMessageEvent) : void
      {
         ...
         var_21.windowManager.alert("${mod.alert.title}","${help.cfh.closed." + method_5(_loc3_.closeReason) + "}",0,onAlertClose);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_21.tellUI(HabboHelpViewEnum.const_149);
      }
      ...
      {
         var_21.showUI(HabboHelpViewEnum.const_295);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_21.showUI(HabboHelpViewEnum.const_462);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_21.showUI(HabboHelpViewEnum.const_582);
         var_21.tellUI(HabboHelpViewEnum.const_582,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_334)
            {
         ...
         var_21.tellUI(HabboHelpViewEnum.const_734);
      }
