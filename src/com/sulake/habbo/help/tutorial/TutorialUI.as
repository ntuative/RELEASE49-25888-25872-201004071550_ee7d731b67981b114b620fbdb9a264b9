package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_197:String = "TUI_NAME_VIEW";
      
      public static const const_87:String = "TUI_MAIN_VIEW";
      
      public static const const_332:String = "TUI_CLOTHES_VIEW";
      
      public static const const_401:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         ...
         _main.events.addEventListener(HabboHelpTutorialEvent.const_621,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_528,onTaskDoneEvent);
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         var_1054 = true;
         if(var_35 != null && (var_35.id == const_197 || var_35.id == const_87))
         {
            showView(const_87);
         }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1576;
         _window.width = _loc2_.width + var_1577;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_727:
               var_1056 = true;
               if(var_35 != null && var_35.id == const_401)
               {
                  showView(const_87);
               }
               break;
            case HabboHelpTutorialEvent.const_621:
               if(var_35 != null && var_35.id == const_332)
               {
                  var_1280 = true;
                  disposeWindow();
               }
      ...
      {
         var_1055 = true;
         if(var_35 != null && (var_35.id == const_332 || var_35.id == const_87))
         {
            showView(const_87);
         }
      }
      ...
      {
         return var_1055 && var_1054 && var_1056;
      }
   }
}
