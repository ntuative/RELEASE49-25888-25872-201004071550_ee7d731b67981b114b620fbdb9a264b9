package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1053:int = 0;
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_670 == null || _loc3_ < 0 || _loc3_ >= var_670.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_670[_loc3_];
            main.showUI(HabboHelpViewEnum.const_668);
            main.tellUI(HabboHelpViewEnum.const_668,null);
         }
      }
   }
}
