package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private static var var_1523:uint = 13232628;
      
      private static var var_2061:uint = 11129827;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_47.localization.registerParameter("help.tutorial.name.available","name",var_355);
      ...
      private function showSelectionView() : void
      {
         if(!var_592)
         {
            var_592 = createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!var_592)
            {
               return;
            }
            _window.content.addChild(var_592);
         }
