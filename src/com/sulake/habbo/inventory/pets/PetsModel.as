package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1255 && param1.type == RoomEngineObjectEvent.const_224)
         {
            var_47.showView();
            var_1255 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1255 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_36,RoomObjectTypeEnum.const_340,_loc3_.figure);
            var_47.closeView();
            return;
         }
      ...
      {
         if(var_1042.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
