package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_319:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_462 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_614 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_614.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_319 != null)
         {
            var_319.setSelected(false);
         }
         var_319 = param1;
         if(var_319 != null)
         {
            var_319.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_319.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_614.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_462.removeGridItem(_loc2_.window);
         if(var_319 == _loc2_)
         {
            var_319 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_614.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_462.addGridItem(_loc2_.window);
            var_614.add(param1.id,_loc2_);
            if(var_319 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = _avatarRenderer.createPetImageFromFigure(_loc12_.figure,AvatarScaleType.const_52);
            if(_loc13_ == null)
            {
               return;
            }
