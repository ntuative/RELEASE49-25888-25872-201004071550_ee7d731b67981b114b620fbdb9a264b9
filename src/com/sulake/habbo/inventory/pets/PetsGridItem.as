package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      public function PetsGridItem(param1:PetsView, param2:PetData, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IAvatarRenderManager)
      {
         ...
         var _loc7_:IAvatarImage = param5.createPetImageFromFigure(param2.figure,AvatarScaleType.const_52);
         if(_loc7_ == null)
         {
            return;
         }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_51:
               var_976.setSelectedGridItem(this);
               var_797 = true;
               break;
            ...
            case WindowMouseEvent.const_30:
               ...
               {
                  var_797 = false;
                  var_976.placePetToRoom(var_1286.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         _window.color = !!_isSelected ? uint(const_1631) : uint(const_1632);
      }
