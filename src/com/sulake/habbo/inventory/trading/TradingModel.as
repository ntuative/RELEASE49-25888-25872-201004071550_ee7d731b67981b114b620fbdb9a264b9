package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_161:uint = 1;
      
      public static const const_150:uint = 0;
      
      public static const const_1253:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_463 = false;
         var_650 = false;
         var_44.updateItemList(var_649);
         var_44.updateItemList(var_1133);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_44.alertPopup(TradingView.const_955);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_649)
            {
               var_463 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_650 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_44.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_649)
            {
               var_44.alertPopup(TradingView.const_846);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_31 + " NEW STATE: " + param1 + " OWN: " + var_463 + " OTHER: " + var_650);
         ...
         {
            case const_150:
               if(param1 == const_161 || param1 == const_199)
               {
                  var_31 = param1;
                  _loc2_ = true;
               }
      ...
      public function close() : void
      {
         if(var_628)
         {
            if(var_31 != const_150 && var_31 != const_199)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_150;
            var_10.toggleInventorySubPage(InventorySubCategory.const_923);
            var_628 = false;
         }
         var_44.setMinimized(false);
      }
