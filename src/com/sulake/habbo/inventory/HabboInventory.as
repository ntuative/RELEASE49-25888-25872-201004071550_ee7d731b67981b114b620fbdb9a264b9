package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_846:IRoomSession;
      ...
      private const const_1641:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            ...
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_459,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_45.getValue(InventoryCategory.const_635));
      }
      ...
      {
         var_111.clubPeriods = param1;
         var_111.clubDays = param2;
         var_111.clubHasEverBeenMember = param3;
         var_111.isVIP = param4;
      ...
      {
         return PetsModel(var_45.getValue(InventoryCategory.const_142));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_816));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1641);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_45.getValue(InventoryCategory.const_339));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_847.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_847.splice(_loc3_,1);
            }
         }
      }
      ...
      public function get clubLevel() : int
      {
         ...
         if(false)
         {
            return HabboClubLevelEnum.const_71;
         }
      ...
      {
         return var_111.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_45.getValue(InventoryCategory.const_305) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1033 = new IncomingMessages(this);
      ...
      {
         return var_111.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_111.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_45.getValue(InventoryCategory.const_259));
      }
      ...
      private function method_9(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_459,roomSessionEventHandler);
         ...
         var_45.add(InventoryCategory.const_305,_loc3_);
         ...
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_358);
         var_45.add(InventoryCategory.const_259,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_45.add(InventoryCategory.const_635,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_358);
         var_45.add(InventoryCategory.const_339,_loc7_);
         ...
         var_45.add(InventoryCategory.const_142,_loc10_);
