package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2272:BitmapData;
      ...
      private const const_1631:int = 8947848;
      
      protected var _items:Map;
      
      protected var _category:int;
      
      protected var var_373:BitmapData;
      
      private const const_1409:Number = 0.2;
      
      protected var var_1379:Boolean;
      
      private const const_1410:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_684)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1422));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1390);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1409;
               _loc1_.blend = const_1409;
            }
            else
            {
               _window.blend = const_1410;
               _loc1_.blend = const_1410;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1379 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2272;
               _loc5_.visible = true;
            }
            else
            {
