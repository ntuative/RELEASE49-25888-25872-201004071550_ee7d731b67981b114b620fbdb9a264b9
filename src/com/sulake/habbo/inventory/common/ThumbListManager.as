package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_975:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_564 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_564.width;
         var_89 = var_564.height;
         var_974 = param5;
         var_795 = param6;
         var_215 = Math.floor(var_974 / _thumbWidth);
         var_17 = new BitmapData(var_974,var_795);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_17.height < var_795)
         {
            _loc12_ = new BitmapData(var_17.width,var_795);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_564.width,var_564.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_564.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_564,var_564.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_975 != null)
         {
            _loc1_ = var_975.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_470 = resolveRowCountFromList();
         if(var_470 == 0)
         {
            var_17 = new BitmapData(var_974,var_795);
            return;
         }
         var_17 = new BitmapData(Math.max(var_215 * _thumbWidth,var_974),Math.max(var_470 * var_89,var_795),true,16777215);
         var_17.fillRect(var_17.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_470)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_215 && var_17.height < _loc3_.y * var_89)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_215 - 1),var_89);
         _loc2_.copyPixels(var_17,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_215 - 1),0,_thumbWidth,var_17.height);
         _loc2_.copyPixels(var_17,_loc4_,new Point(0,var_89),null,null,true);
         _loc4_ = new Rectangle(0,var_89,_thumbWidth * (var_215 - 1),0 - var_89);
