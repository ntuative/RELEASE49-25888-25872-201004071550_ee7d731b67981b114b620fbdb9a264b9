package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1663:int = 2;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_514 = new Map();
         var_514.add(FurniModel.const_42,new FurniGridView(_model,FurniModel.const_42,_windowManager,_assetLibrary,_roomEngine));
         var_514.add(FurniModel.const_43,new FurniGridView(_model,FurniModel.const_43,_windowManager,_assetLibrary,_roomEngine));
         ...
         else if(param1.type == WindowEvent.const_58)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  switchCategory(FurniModel.const_325);
            }
         }
      }
      ...
      public function updateActionView() : void
      {
         ...
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_321)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_290)
            {
