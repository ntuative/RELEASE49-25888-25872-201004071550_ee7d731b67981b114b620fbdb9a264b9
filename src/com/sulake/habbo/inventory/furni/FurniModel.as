package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_325:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_503 = new Timer(const_1072,1);
         var_503.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_47.getSubCategoryViewId() == InventorySubCategory.const_246;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_414.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_414.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_684)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_503 != null)
            {
               var_503.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_503.stop();
               var_503 = null;
            }
            if(var_128 != null)
            {
               var_128.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_128.stop();
               var_128 = null;
            }
            if(var_697 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_321)
         {
         ...
         else if(param3 == FurniCategory.const_290)
         {
         ...
         if(var_697 == null)
         {
            var_697 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_697.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_246:
               ...
               break;
            case InventorySubCategory.const_923:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_128 = new Timer(param1,1);
            var_128.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_128.start();
         }
         else
         {
      ...
      {
         var_47.checkCategoryInitilization(InventoryCategory.const_305);
         ...
         if(param1 == InventoryCategory.const_75 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_43:
                  ...
                  break;
               case const_325:
                  var_47.toggleInventoryPage(InventoryCategory.const_142);
            }
         }
      }
      ...
      {
         if(var_845 && param1.type == RoomEngineObjectEvent.const_224)
         {
            var_47.showView();
            var_845 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_290 || _loc3_.category == FurniCategory.const_321 || _loc3_.category == FurniCategory.const_294)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_414 = new Map();
         var_414.add(const_42,new Array());
         var_414.add(const_43,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
