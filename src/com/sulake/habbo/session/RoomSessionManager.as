package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(initialized && var_1254)
         {
            gotoRoom(var_2026,var_2027,var_1253);
            var_1254 = false;
            var_1253 = "";
         }
      }
      ...
      public function sessionUpdate(param1:int, param2:int, param3:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_814:
                  break;
               case RoomSessionHandler.const_933:
                  break;
               case RoomSessionHandler.const_676:
