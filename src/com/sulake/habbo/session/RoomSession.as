package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_979:UserDataManager;
      ...
      {
         if(var_31 == RoomSessionEvent.const_319 && _connection != null)
         {
            var_31 = RoomSessionEvent.const_93;
            if(isPrivateRoom)
            {
      ...
      {
         return var_979 as IUserDataManager;
      }
