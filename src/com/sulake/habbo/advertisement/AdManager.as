   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_373,0,0,_loc4_,var_1602,var_934,var_935));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2269 = int(_config.getKey("interstitial.interval","30000"));
         var_2268 = int(_config.getKey("interstitial.show.time","5000"));
         var_1603 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1375 = _loc2_.imageUrl;
         var_1602 = _loc2_.clickUrl;
         if(var_1375 != "" && var_1602 != "")
         {
            _loc3_ = var_1375;
            ...
            _loc4_ = new URLRequest(var_1375);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1376 = _loc2_.imageUrl;
         var_2267 = _loc2_.clickUrl;
         var_768 = getTimer();
         if(var_1376 != "")
         {
            _loc3_ = var_1376;
            ...
            if(var_242 == null)
            {
               var_242 = new Timer(var_2268,1);
               var_242.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_242.reset();
            ...
            var_242.start();
            _loc4_ = new URLRequest(var_1376);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_442,0,0,param1.bitmapData,var_2267));
            var_768 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_935 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1603 > 0 && var_1601 >= var_1603)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_768;
         if(_loc1_ > var_2269)
         {
            ++var_1601;
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_934 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
