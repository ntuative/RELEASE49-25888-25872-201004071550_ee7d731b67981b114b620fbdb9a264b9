package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_207 = param5.getKey("notifications.text.achievement");
         ...
         setText("achievement_info",var_207);
      ...
      public function dispose() : void
      {
         if(var_358 != null)
         {
            var_358.events.removeEventListener(BadgeImageReadyEvent.const_120,onBadgeImageReady);
            var_358 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_730,var_2119);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_730,var_730));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_730,var_730));
         _localizations.registerParameter(param1,"level",var_1857.toString());
         _localizations.registerParameter(param1,"name",var_358.userName);
         _localizations.registerParameter(param1,"realname",var_358.realName);
      }
   }
}
