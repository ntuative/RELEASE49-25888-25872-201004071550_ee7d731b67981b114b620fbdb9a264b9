package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1101:String = "badges";
      
      private static const const_1097:String = "pet_inventory";
      
      private static const const_1100:String = "pixelbalance";
      
      private static const const_1104:String = "credits";
      
      private static const const_1099:String = "inventory";
      
      private static const const_1102:String = "friendlist";
      
      private static const const_1098:String = "selectfurni";
      
      private static const const_1103:String = "selectbadge";
      ...
      private var var_423:HabboNotificationViewManager;
      
      private var var_725:ClubEndingNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_875);
         }
         var _loc6_:Map = var_875["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1372);
         }
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1213);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2102)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_976);
            var_2102 = true;
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1097:
               if(var_10)
               {
                  var_10.toggleInventoryPage(InventoryCategory.const_142);
               }
               break;
            case const_1098:
               break;
      ...
      {
         if(param1 != null && this.var_423 != null)
         {
            var_423.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_976,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_585.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_52);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_942,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_163 || param2.type == WindowEvent.const_559)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_423.isSpaceAvailable() && false)
         {
            var_423.showItem(getNextItemFromQueue());
         }
      }
      ...
      {
         var _loc1_:Array = var_1068.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_585.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_52);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_358);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc9_ = _loc4_.products[0];
            if(_loc4_.products.length > 0)
            {
               if(_loc9_.productType == CatalogPageMessageProductData.const_77)
               {
                  _loc10_ = var_358.getFloorItemData(_loc9_.furniClassId);
               }
               else if(_loc9_.productType == CatalogPageMessageProductData.const_82)
               {
                  _loc10_ = var_358.getWallItemData(_loc9_.furniClassId);
               }
               _loc6_ = var_358.getProductData(_loc4_.localizationId);
               _loc5_ = getProductImage(_loc9_.productType,_loc9_.furniClassId,_loc9_.extraParam);
            }
         }
         ...
         if(_loc8_)
         {
            addItem(_loc8_.value,NotificationType.const_1351,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_585.createAvatarImage(param2,AvatarScaleType.const_52);
         if(_loc7_ != null)
         {
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var_1068.push(_loc8_);
         return var_1068.length;
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1186)
         {
         ...
         {
            _loc6_ = parseInt(_config.getKey("subscription.reminder.when.days.left","5"));
            if(_loc6_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc6_ && _loc2_.periodsSubscribedAhead == 0)
            {
               if(var_725)
               {
                  var_725.dispose();
               }
               var_725 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_598.events.addEventListener(HabboToolbarEvent.const_86,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_358.userId == _loc2_.userId)
         {
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_86)
         {
            ...
            var_423 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_875["styles"],var_875["view"],var_598);
            ...
            registerUpdateReceiver(var_423,1);
            registerUpdateReceiver(this,2);
            var_358.events.addEventListener(BadgeImageReadyEvent.const_120,onBadgeImage);
