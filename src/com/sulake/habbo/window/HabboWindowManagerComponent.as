package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1188:ProfilerAgentTask;
      
      private var var_1185:IEventDispatcher;
      
      private var var_2380:uint = 0;
      
      private var var_1186:ProfilerAgentTask;
      
      private var var_1187:ProfilerOutput;
      
      private var var_674:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1185 = Component(param1).events;
         var_399 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_675 = new SkinContainer(_loc3_.content as XML,assets);
         var_674 = new WindowRenderer(var_675);
         var_219 = new Array(const_347);
         var _loc5_:int = 0;
         while(_loc5_ < const_347)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_674,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_219[_loc5_] = _loc4_;
            _loc5_++;
         }
         _windowContext = var_219[const_1056];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_313,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1373,_loc6_);
      }
      ...
      {
         var _loc3_:Dictionary = var_399[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_399[0][param1] as XML : _loc4_;
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1187 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1187 = new ProfilerOutput(_loc3_,this,var_674);
               var_1188 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1188);
               var_1186 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1186);
               var_996 = true;
            }
         }
      }
      ...
      {
         return var_675.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1185.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_347 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1185.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         if(WindowContext.var_1377.length > 0)
         {
            WindowContext.var_1377.flush();
         }
         var_1185.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1150,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1374,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1339,param2.name + ": " + param2.toString());
            }
         }
      }
   }
