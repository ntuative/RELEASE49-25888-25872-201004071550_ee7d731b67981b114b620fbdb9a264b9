package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_808:IWindow;
      
      private var var_409:Number;
      
      private var var_810:ITextWindow;
      ...
      {
         super();
         var_168 = new Timer(1000);
         var_168.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_808 = _window.findChildByName("effect_hilite");
            var_808.visible = false;
         }
         var_810 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_809 = _window.findChildByName("loader_bar");
         if(var_809 != null)
         {
            var_409 = var_809.width;
            var_168.start();
            onUpdate();
         }
         if(false)
      ...
      public function dispose() : void
      {
         ...
         {
            var_168.stop();
            var_168.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_168 = null;
         }
         _container = null;
         if(_window != null)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_810 != null)
         {
            var_810.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_810.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
