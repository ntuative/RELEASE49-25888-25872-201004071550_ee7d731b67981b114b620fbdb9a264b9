package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_786:MeMenuSettingsView;
      ...
      {
         if(param1.type != WindowEvent.const_458)
         {
            return;
         }
         var_786.saveVolume(getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && var_549 != null)
            {
               ...
               var_1395 = _loc1_.width - _loc2_.width;
            }
         }
      }
      ...
      {
         return int(var_1395 * (Number(param1 - var_644) / (var_955 - var_644)));
      }
      ...
      {
         return param1 / var_1395 * (var_955 - var_644) + var_644;
      }
   }
}
