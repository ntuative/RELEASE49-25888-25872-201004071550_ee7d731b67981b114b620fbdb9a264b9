      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_978);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_884));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_614);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_981));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_303);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_940));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_606);
               break;
            case "news":
               if(false && false)
               {
