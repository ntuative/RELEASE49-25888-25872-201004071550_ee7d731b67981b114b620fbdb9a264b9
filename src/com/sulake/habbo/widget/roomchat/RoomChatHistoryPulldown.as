package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_37 = param3;
         var_1640 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1400 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_1644 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1401 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1402 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_1642 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_1643 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_68 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_40,HabboWindowParam.const_69,new Rectangle(0,0,param3.width,param3.height - const_73),null,0,0) as IBitmapWrapperWindow;
         var_37.addChild(var_68);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_59,HabboWindowStyle.const_40,HabboWindowParam.const_41,new Rectangle(0,0 - const_73,param3.width,const_73),null,0) as IWindowContainer;
         var_37.addChild(_window);
         var_94 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_417,HabboWindowStyle.const_39,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_73),null,0) as IRegionWindow;
         if(var_94 != null)
         {
            var_94.background = true;
            var_94.mouseTreshold = 0;
            var_94.addEventListener(WindowMouseEvent.const_51,onPulldownMouseDown);
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(var_94 != null)
         {
            var_94.x = 0;
            var_94.y = 0 - const_73;
            var_94.width = 0 - var_1645;
         }
         if(var_68 != null)
         {
            var_68.rectangle = var_37.rectangle;
            var_68.height = 0 - const_73;
         }
         buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_1641 == _window.width)
         {
            return;
         }
         var_1641 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_1640.clone(),_loc7_);
               _loc1_.bitmap = _loc7_;
            }
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               _loc8_ = new BitmapData(_loc3_.width,_loc3_.height);
               tileBitmapHorz(var_1400.clone(),_loc8_);
               _loc3_.bitmap = _loc8_;
            }
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               _loc9_ = new BitmapData(_loc4_.width,_loc4_.height);
               tileBitmapHorz(var_1400.clone(),_loc9_);
