package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_146.state = RoomChatHistoryPulldown.const_211;
         ...
         var_41 = param2.createWindow("chatscroller","",HabboWindowType.const_865,HabboWindowStyle.const_39,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_220 > 0 && param2)
         {
            if(var_1201)
            {
               if(Math.abs(param1 - var_220) <= const_1026)
               {
                  return;
               }
               var_1201 = false;
            ...
            if(var_301)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(var_41.scrollV < 1 - const_1063 / var_41.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1478)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_301 && !var_1291)
         {
            ...
            var_146.state = RoomChatHistoryPulldown.const_311;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_146.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_211);
      }
