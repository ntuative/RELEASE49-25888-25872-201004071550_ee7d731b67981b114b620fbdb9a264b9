package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_486:int = 6;
      
      private static const const_348:int = 10;
      
      private static const const_1064:Number = 18;
      
      private static const const_1417:Number = 10;
      
      private static const const_1418:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1012,var_1013,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1012,var_686,var_1013,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1208 = param1.chatType;
         var_1012 = param1.userId;
         var_686 = param1.userName;
         var_1013 = param1.userCategory;
         _message = param1.text;
         var_1207 = param1.userX;
         var_188 = param1.userImage;
         var_1014 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(var_188 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_403 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1014 != 0)
            {
               _loc30_ = uint(var_1014 >> 16 & 255);
               _loc31_ = uint(var_1014 >> 8 & 255);
               _loc32_ = uint(var_1014 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_348;
            }
            else
            {
               _loc19_.text = var_686 + ":";
               _loc19_.y += var_403;
               _loc19_.width = _loc19_.textWidth + const_348;
               _width += _loc19_.textWidth + const_348;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1208 == RoomWidgetChatUpdateEvent.const_252)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_686);
            }
            else if(var_1208 == RoomWidgetChatUpdateEvent.const_261)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_686);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_403;
            _loc20_.width = _loc20_.textWidth + const_486;
            _width += _loc20_.textWidth + const_486;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_348 + _loc20_.textWidth + const_486;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1012,var_1013,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1012,var_1013,_roomId,_roomCategory,param1);
      }
