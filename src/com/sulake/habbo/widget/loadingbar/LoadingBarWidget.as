package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_390:Sprite = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_248,onHideLoadingBar);
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_390 = new Sprite();
            var_390.addChild(new Bitmap(_image));
            var_390.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_390.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_390);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1423 != "")
         {
            HabboWebTools.openWebPage(var_1423);
         }
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_248,onHideLoadingBar);
      }
      
      private function onHideLoadingBar(param1:RoomWidgetLoadingBarUpdateEvent) : void
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_248)
         {
            return;
         }
         if(_window != null)
      ...
      override public function dispose() : void
      {
         if(var_390 != null)
         {
            var_390.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_390 = null;
         }
         if(_image != null)
         {
