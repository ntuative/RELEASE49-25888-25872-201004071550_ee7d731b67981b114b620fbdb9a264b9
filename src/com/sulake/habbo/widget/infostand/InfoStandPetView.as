package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1648:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1650:String = "level";
      
      private var var_96:IItemListWindow;
      
      private const const_1646:String = "energy";
      
      private var var_1286:Map;
      
      private const const_1649:String = "nutrition";
      
      private var var_60:IItemListWindow;
      
      private const const_1647:uint = 3355443;
      
      private var var_213:IBorderWindow;
      
      private const const_1643:int = 158;
      
      private const const_1645:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_173:PetCommandTool;
      
      private const const_1651:uint = 11184810;
      
      private const const_1644:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_213 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_213 != null)
         {
            var_96 = var_213.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_213.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_213.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      {
         if(var_96 == null || var_213 == null || var_60 == null)
         {
            return;
         }
         ...
         var_213.height = NaN;
         _window.width = Math.max(var_213.width,var_60.width);
      ...
      private function openTrainView() : void
      {
         if(var_173 == null)
         {
            var_173 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1286.getValue(var_613) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_173.showWindow(true);
            var_173.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1650,param1.level,param1.levelMax);
         updateStateElement(const_1644,param1.experience,param1.experienceMax);
         updateStateElement(const_1646,param1.energy,param1.energyMax);
         updateStateElement(const_1649,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_613 = param1.id;
         var_1286.remove(param1.id);
         var_1286.add(param1.id,param1);
         if(var_173 && var_173.isVisible() && param1.isOwnPet)
         {
            var_173.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_173.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_173 && var_173.getPetId() == var_613)
               {
                  var_173.showWindow(false);
               }
               break;
            case "btn_train":
               openTrainView();
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1643,const_1645,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1651);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1647);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1648);
         return _loc5_;
      }
