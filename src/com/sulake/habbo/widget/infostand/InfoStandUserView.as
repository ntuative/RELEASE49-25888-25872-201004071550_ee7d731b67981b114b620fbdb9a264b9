package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         _window.name = param1;
         var _loc6_:IBitmapWrapperWindow = var_213.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = var_213.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = var_213.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
         ...
         _loc10_ = var_213.findChildByName("badge_group");
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_858:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_874:
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_213:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_232:
