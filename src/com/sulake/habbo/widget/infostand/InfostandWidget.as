package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private var var_1286:InfoStandPetData;
      
      private var var_138:Timer;
      
      private var var_907:InfoStandFurniView;
      
      private var var_414:InfostandFurniData;
      
      private var var_366:InfoStandBotView;
      ...
      private const const_1429:String = "infostand_furni_view";
      
      private const const_1655:int = 3000;
      
      private var var_203:InfoStandUserView;
      
      private var var_386:InfostandUserData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_907 = new InfoStandFurniView(this,const_1429);
         var_203 = new InfoStandUserView(this,const_1430);
         var_320 = new InfoStandPetView(this,const_1432);
         var_366 = new InfoStandBotView(this,const_1431);
         var_386 = new InfostandUserData();
         var_414 = new InfostandFurniData();
         var_1286 = new InfoStandPetData();
         var_138 = new Timer(const_1655);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         if(param1.isOwnUser)
         {
            var_203.setTags(param1.tags);
         }
         else
         {
            var_203.setTags(param1.tags,var_2199);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_610,onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_575,onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_471,var_320.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_610,onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_575,onBadgeImage);
      ...
      private function onUserFigureUpdate(param1:RoomWidgetUserFigureUpdateEvent) : void
      {
         ...
         if(userData.isBot())
         {
            var_366.image = param1.image;
         }
         else
         {
            var_203.image = param1.image;
         }
      }
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(userData.isBot())
            {
               var_366.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
               var_203.setBadgeImage(_loc2_,param1.badgeImage);
            }
            return;
         }
         if(param1.badgeID == userData.groupBadgeId)
         {
            var_203.setGroupBadgeImage(param1.badgeImage);
         }
      }
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            _mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_59,HabboWindowStyle.const_39,HabboWindowParam.const_39,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_117:
               _loc2_ = param1.id == var_414.id;
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_267:
               if(var_203 != null && false && var_203.window.visible)
               {
                  _loc2_ = param1.id == var_386.userRoomId;
                  break;
               }
               if(var_320 != null && false && var_320.window.visible)
               {
                  _loc2_ = param1.id == var_1286.roomIndex;
                  break;
               }
               if(var_366 != null && false && var_366.window.visible)
               {
                  _loc2_ = param1.id == var_386.userRoomId;
                  break;
               }
