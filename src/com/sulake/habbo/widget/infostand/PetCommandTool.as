package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_363:IFrameWindow;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         _widget = param1;
         var_1032 = new Map();
         var_364 = new Timer(const_1654);
         var_364.addEventListener(TimerEvent.TIMER,onButtonDisableTimeout);
      }
      ...
      private function createCommandWindow() : void
      {
         ...
         var_40.context.getDesktopWindow().addEventListener(WindowEvent.const_45,onWindowDesktopResized);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_515,param1);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(var_363 == null)
         {
            ...
            var_363 = (_widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(var_363 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            var_363.x = 200;
            var_363.procedure = onInfoWindowProcedure;
         }
         else
         {
      ...
      {
         var _loc2_:Array = var_1032.getValue(var_613) as Array;
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_471,var_613));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_653,var_613,var_2186 + " " + _loc6_);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = var_1032.getValue(param1) as Array;
         if(_loc6_ == null)
         {
            updateCommandButtonsViewState(new Array());
            requestEnabledCommands(var_613);
         }
         else
         {
