package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_486:int = 16;
      
      private static const const_1089:int = 20;
      
      private static const const_348:int = 10;
      
      private static const const_1090:int = 40;
      ...
      private var var_409:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1047 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2046 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2047 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_708 = new Timer(1000,1);
         var_708.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_59,HabboWindowStyle.const_39,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_134,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_45,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_136,onInputChanged);
         _window.addEventListener(WindowEvent.const_458,onWindowMoved);
         var_1268 = true;
         var_129 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2048 = _loc2_.width + const_486 + _loc6_.width + const_1089;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1090,_loc8_.width) + const_486);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1047 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_129 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_409);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_409);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_510);
