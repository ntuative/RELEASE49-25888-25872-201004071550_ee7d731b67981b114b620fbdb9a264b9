package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_543,var_157);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_59,HabboWindowStyle.const_40,0 | 0,new Rectangle(const_1035,const_1034,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null && var_207 != null)
         {
            _loc6_.caption = var_207;
         }
