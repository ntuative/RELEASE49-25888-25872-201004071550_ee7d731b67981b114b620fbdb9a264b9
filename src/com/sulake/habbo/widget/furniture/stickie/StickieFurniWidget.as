package com.sulake.habbo.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1039:int = 500;
      
      private static const const_1035:Number = 100;
      
      private static const const_1040:int = 14;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetStickieDataUpdateEvent.const_592,onObjectUpdate);
      ...
      private function sendSetColor(param1:uint) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_431,var_157,var_207,var_653);
      ...
      private function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_662,var_157);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetStickieDataUpdateEvent.const_592,onObjectUpdate);
      }
      ...
      {
         hideInterface();
         var_157 = param1.objectId;
         var_1413 = param1.objectType;
         var_207 = param1.text;
         var_653 = param1.colorHex;
      ...
      private function sendUpdate() : void
      {
         ...
         if(messageListener != null)
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_431,var_157,var_207,var_653);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function showInterface() : void
      {
         ...
         if(_window == null)
         {
            _window = windowManager.createWindow("stickieui_container","",HabboWindowType.const_59,HabboWindowStyle.const_40,0 | 0,new Rectangle(const_1035,const_1034,2,2),null,0) as IWindowContainer;
         ...
         {
            _loc3_.text = var_207;
            _loc3_.addEventListener(WindowEvent.const_136,onTextWindowEvent);
         }
         _loc6_ = _window.findChildByTag("bg") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
            if(var_1413 == "post_it_vd")
            {
            ...
            else
            {
               ...
               _loc6_.color = uint("0xFF" + var_653);
            }
         ...
         setColorButtons(var_47 && var_1413 == "post_it");
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1039;
         if(_loc2_.numLines < const_1040)
         {
            return;
         }
