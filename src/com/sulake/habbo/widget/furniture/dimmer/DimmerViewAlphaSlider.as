package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_98 && param1.type != WindowMouseEvent.const_455)
         {
            return;
         }
      ...
      {
         return int(param1 / var_1395 * (var_955 - var_644)) + var_644;
      }
   }
}
