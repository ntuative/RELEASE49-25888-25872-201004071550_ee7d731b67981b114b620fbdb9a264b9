package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_436.destroyGridItems();
         var_319 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1339) as IWindowContainer;
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onClick);
            _loc3_.background = true;
            _loc3_.color = 4294967295;
            _loc3_.width = var_536.width;
            _loc3_.height = var_536.height;
            var_436.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_536.width,var_536.height,true,0);
               _loc4_.bitmap.copyPixels(var_536,var_536.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_915.width,var_915.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_752.width,var_752.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_752,var_752.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_436.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_436.numGridItems)
         {
            return;
         }
         select(var_436.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_319 != null)
         {
            _loc2_ = var_319.getChildByName("chosen");
            if(_loc2_ != null)
            {
