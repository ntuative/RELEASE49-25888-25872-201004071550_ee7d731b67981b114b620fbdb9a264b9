package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_655[var_963] as Dictionary;
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_963;
         if(var_963 < var_655.length)
         {
            _loc1_ = var_655[var_963] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_655.length);
                  _loc2_.text = _loc6_;
               }
