package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(_view != null)
         {
            var_509 = _view.findChildByName("part_thumbs") as IItemGridWindow;
            var_418 = new Array();
            var_418.push(_view.findChildByName("palette0") as IItemGridWindow);
            var_418.push(_view.findChildByName("palette1") as IItemGridWindow);
         }
      }
      ...
      private function paletteEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_51)
         {
            ...
            _loc7_ = 0;
            while(_loc7_ < const_1073)
            {
               if(var_418.length > _loc7_)
               {
                  _loc4_ = var_418[_loc7_] as IItemGridWindow;
      ...
      public function initFromList() : void
      {
         ...
         for each(_loc2_ in _loc1_.parts)
         {
            if(_loc2_)
            {
               var_509.addGridItem(_loc2_.view);
         ...
         _loc3_ = 0;
         while(_loc3_ < const_1073)
         {
            _loc4_ = _loc1_.getPalette(_loc3_);
            _loc5_ = var_418[_loc3_] as IItemGridWindow;
            if(!(!_loc4_ || !_loc5_))
            {
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_51)
         {
            _loc3_ = var_509.getGridItemIndex(param1.window);
