package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1416:int = 60000;
      ...
      private var var_858:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_724)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_405)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_53.getParts(param1,(var_858 as AvatarImage).getFigure(),_loc6_,var_1204,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_53.getCanvas(var_193,var_1204);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc23_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1188[param1])
            {
            ...
            _loc9_ = var_193 + "_" + _loc15_.assetPartDefinition + "_" + _loc10_ + "_" + _loc11_ + "_" + _loc18_ + "_" + _loc12_;
            _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            if(_loc14_ == null)
            {
               _loc9_ = var_193 + "_std_" + _loc10_ + "_" + _loc11_ + "_" + _loc18_ + "_0";
               _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            }
            ...
            else
            {
               ...
               if((_loc29_ == AvatarAction.const_972 || _loc29_ == AvatarAction.const_645) && (_loc6_ == AvatarBodyPartType.const_280 || _loc6_ == AvatarBodyPartType.const_1352 || _loc6_ == AvatarBodyPartType.const_1333) && _loc7_.color != null)
               {
         ...
         if(_loc17_)
         {
            if(var_193 == AvatarScaleType.const_52)
            {
               _loc25_.x += 67;
            }
            else
