package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit
   {
      ...
      public function updateView() : void
      {
         ...
         if(var_308 && var_1223)
         {
            _loc5_ = var_47.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.SMALL);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_38,parseInt(FigureData.const_693));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               var_308 = var_47.figureData.getFigureString();
               var_693 = var_47.gender;
               var_47.handler.saveWardrobeOutfit(var_1499,this);
               updateView();
               break;
            case "get_button":
               if(var_308)
               {
                  var_47.loadAvatarInEditor(var_308,var_693,var_47.clubMemberLevel);
               }
         }
      }
   }
