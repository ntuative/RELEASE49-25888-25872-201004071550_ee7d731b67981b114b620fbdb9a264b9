package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1082:String = AvatarSetType.const_38;
      ...
      private var var_308:AvatarFigureContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String, param6:String = null)
      {
         ...
         if(var_193 == null)
         {
            var_193 = AvatarScaleType.const_52;
         }
         ...
         var_308 = new AvatarFigureContainer(param3);
         if(param6)
         {
            ...
            if(_loc7_)
            {
               ...
               {
                  if(!var_308.hasPartType(_loc9_))
                  {
                     _loc10_ = var_53.getDefaultPartSet(_loc9_,param6);
                     if(_loc10_)
                     {
                        var_308.updatePart(_loc9_,_loc10_.id,[0]);
                     }
                  }
                  else
                  {
                     _loc11_ = _loc8_.getSetType(_loc9_);
                     _loc12_ = _loc11_.getPartSet(var_308.getPartSetId(_loc9_));
                     if(!_loc12_)
                     {
                        _loc13_ = var_53.getDefaultPartSet(_loc9_,param6);
                        var_308.updatePart(_loc9_,_loc13_.id,[0]);
                     }
                  }
               }
            }
         ...
         {
            _loc14_ = var_308.getPartSetId("pbd");
            solvePetAvatarTypeAndBreed(_loc14_);
            var_1258 = var_1044;
         }
         var_125 = new AvatarImageCache(var_53,this,_assets,var_193);
         setDirection(const_1082,const_1080);
         var_194 = new Array();
         resetActions();
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += var_1260;
         if(param2 < AvatarDirectionAngle.const_1297)
         {
            param2 = AvatarDirectionAngle.const_624 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_624)
         {
            param2 -= NaN;
         }
         if(var_671 == AvatarType.PET && param1 == AvatarSetType.const_46)
         {
            if((var_90 == 6 || var_90 == 0) && param2 == 7)
            {
               param2 = var_90;
            }
            _loc3_ = var_53.renderManager.petDataManager.getPetData(var_1258);
            if(_loc3_ != null)
            {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         var_417 = false;
         var _loc1_:Array = var_53.sortActions(var_194);
         if(_loc1_ == null)
         {
         ...
         {
            var_588 = var_53.getCanvasOffsets(_loc1_,var_193,var_90);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_1260 = _loc3_.directionData.offset;
                  }
            ...
            if(_loc2_.actionType == AvatarAction.const_645)
            {
               var_417 = true;
            }
            if(_loc2_.actionType == AvatarAction.const_368)
            {
               var_417 = true;
            }
      ...
      {
         return var_53.getPartColor(var_308,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_53.getCanvas(var_193,var_169.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_53.getBodyParts(param1,var_169.definition,var_90);
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(var_671 == AvatarType.PET)
               {
                  _loc14_ = getCache().getBodyPartCache(_loc9_);
                  _loc15_ = _loc14_.getAction();
                  _loc16_ = _loc15_.definition.assetPartDefinition;
                  _loc17_ = var_53.getParts(_loc9_,var_308,_loc15_,"pet",_loc14_.getDirection(),[]);
                  _loc18_ = 32;
                  if(var_193 == AvatarScaleType.SMALL)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     ...
                     _loc23_ = var_53.getPartActionOffset(getSubType(),var_193,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = var_53.getCanvas(var_193,var_169.definition.geometryType);
         if(_image == null || _loc4_ != null && (_image.width != _loc4_.width || _image.height != _loc4_.height))
         {
            _loc4_ = var_53.getCanvas(var_193,var_169.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               if(var_671 == AvatarType.PET)
               {
                  ...
                  _loc15_ = var_53.getParts(_loc8_,var_308,_loc13_,"pet",_loc12_.getDirection(),[]);
                  _loc16_ = var_1258 < 3;
                  ...
                  if(_loc15_.length > 0)
                  {
                     ...
                     _loc22_ = var_53.getPartActionOffset(getSubType(),var_193,_loc8_,_loc14_,_loc19_,_loc20_);
                     if(_loc22_ != null)
                     {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_169 = new ActiveActionData(AvatarAction.const_880);
         var_169.definition = var_53.getActionDefinition(const_1081);
      ...
      {
         return var_53.getBodyPartData(param1.animation.id,var_486,param1.id);
      }
