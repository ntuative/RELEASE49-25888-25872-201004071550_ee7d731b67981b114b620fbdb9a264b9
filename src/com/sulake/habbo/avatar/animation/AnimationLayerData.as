package com.sulake.habbo.avatar.animation
{
   ...
   public class AnimationLayerData implements IAnimationLayerData
   {
      ...
      public static const const_724:String = "bodypart";
      
      public static const const_405:String = "fx";
      ...
      private var var_1524:IActiveActionData;
      ...
      public function AnimationLayerData(param1:AvatarStructure, param2:XML, param3:String, param4:int, param5:IActionDefinition)
      {
         ...
         var_2067 = parseInt(param2.@frame);
         _dx = parseInt(param2.@dx);
         var_1324 = parseInt(param2.@dy);
         var_1323 = parseInt(param2.@dz);
         var_1260 = parseInt(param2.@dd);
         _type = param3;
         var_1052 = String(param2.@base);
         ...
         if(param5 != null)
         {
            var_1524 = new ActiveActionData(param5.state,_loc7_);
            var_1524.definition = param5;
         }
      }
      ...
      public function baseAsInt() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_1052.length)
         {
            _loc1_ += var_1052.charCodeAt(_loc2_);
            _loc2_++;
         }
         return _loc1_;
      }
