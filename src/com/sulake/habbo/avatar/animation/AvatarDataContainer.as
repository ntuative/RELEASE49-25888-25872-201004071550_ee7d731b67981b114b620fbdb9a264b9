package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1408:Number = 1;
      
      private var _b:uint;
      
      private var var_1407:Number = 1;
      
      private var var_1574:int;
      
      private var _colorTransform:ColorTransform;
      
      private var var_2208:uint;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1404,var_1407,var_1408,_alphaMultiplier);
         var_1089 = generatePaletteMapForGrayscale(var_2208,var_2207);
      }
      
      public function get reds() : Array
      {
         return var_1089.getValue("reds") as Array;
      }
      ...
      {
         return var_1089.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1089.getValue("greens") as Array;
      }
      ...
      {
         return var_1089.getValue("alphas") as Array;
      }
