package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_848:AvatarEditorHandler;
      ...
      private const const_1073:int = 2;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_699.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_160)
         {
            ...
            var_504["null"] = new FigureData(this);
            var_504["null"] = new FigureData(this);
            _loc1_ = var_504["null"];
            _loc2_ = var_504["null"];
            ...
            var_86 = new Map();
            var_415 = new Map();
            var_86.add(AvatarEditorFigureCategory.const_835,new BodyModel(this));
            var_86.add(AvatarEditorFigureCategory.const_46,new HeadModel(this));
            var_86.add(AvatarEditorFigureCategory.const_280,new TorsoModel(this));
            var_86.add(AvatarEditorFigureCategory.const_1222,new LegsModel(this));
            var_86.add(AvatarEditorFigureCategory.const_1279,new HotLooksModel(this));
            var_415.add(AvatarEditorSideCategory.WARDROBE,new WardrobeModel(this));
            var_415.add(AvatarEditorSideCategory.const_381,new ClubPromoModel(this));
            var_160 = true;
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1034 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1508;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1034 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1073)
                  {
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1291)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_1034 >= _loc6_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_415.getValue(AvatarEditorSideCategory.WARDROBE);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_848 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_699.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = var_415.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(_windowContext == null)
            {
               _windowContext = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_59,HabboWindowStyle.const_40,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorFigureCategory.const_835);
         return true;
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_699 = var_585.getFigureData(AvatarType.const_80);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_585 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_1034 = param3;
         var _loc4_:FigureData = var_504[param2];
         if(_loc4_ == null)
         {
            return;
         }
