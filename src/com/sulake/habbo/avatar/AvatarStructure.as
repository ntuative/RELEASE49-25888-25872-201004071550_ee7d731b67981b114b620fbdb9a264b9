package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_398:PartSetsData;
      
      private var var_1834:PartOffsetData;
      
      private var var_818:AvatarActionManager;
      
      private var var_166:IAssetLibrary;
      
      private var var_991:IAssetLibrary;
      
      private var var_1833:AvatarRenderManager;
      ...
      private var var_1468:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_398 = new PartSetsData();
         _animationData = new AnimationData();
         var_1468 = new AvatarStructureDownloadSet();
         var_672 = new AnimationManager();
         var_671 = param4;
         var_1834 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_818.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_671)
         {
            case AvatarType.const_80:
               _loc1_ = var_166.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_398.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_166.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_166.getAssetByName("HabboAvatarFigure").content as XML;
               ...
               break;
            case AvatarType.PET:
               _loc1_ = var_166.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_398.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_166.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_166.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_300.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_818.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         return var_818.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_672.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_398.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_398.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1270[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_818.getDefaultActionType();
         var _loc9_:Array = var_398.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_672.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        if(_loc14_.indexOf(_loc28_.type) > -1)
                        {
                           ...
                           _loc13_ = var_398.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_398.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_80:
               if(var_166.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_166.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_166.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_166.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      private function onStructureReady(param1:Event = null) : void
      {
         ...
         if(var_671 == AvatarType.const_80)
         {
            var_398.getPartDefinition("ri").appendToFigure = true;
            var_398.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_80:
               if(var_166.hasAsset(_loc5_))
               {
                  var_166.removeAsset(var_166.getAssetByName(_loc5_));
               }
               var_1468.add(new AvatarStructureDownload(var_166,_loc5_,var_300));
               break;
            case AvatarType.PET:
         }
         var_1468.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_672.getAnimation(param1);
      }
      ...
      {
         var_818 = new AvatarActionManager(var_166,var_671);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1179 = var_300.getMandatorySetTypeIds();
         return var_1179;
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_991.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_991.getAssetByName("dance" + _loc1_).content as XML;
            var_672.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_991.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_991.getAssetByName("fx" + _loc1_).content as XML;
            var_672.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_818.sortActions(param1);
      }
   }
}
