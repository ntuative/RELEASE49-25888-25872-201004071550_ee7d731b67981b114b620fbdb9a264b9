package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
         ...
         for each(_loc3_ in param2)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc4_.hasAsset("petData"))
               {
                  ...
                  var_755.add(int(_loc6_.@species),new PetData(_loc6_));
               }
            }
         }
      }
      ...
      {
         return var_755.getValue(param1) as IPetData;
      }
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = var_755.getKeys();
         for each(key in speciesKeys)
         {
            petData = var_755.getValue(key);
            if(petData != null)
            {
      ...
      {
         var _loc4_:PetData = var_755.getValue(param1);
         if(_loc4_ == null)
         {
