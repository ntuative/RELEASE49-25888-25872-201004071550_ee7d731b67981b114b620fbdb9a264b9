package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private var var_1399:ITabSelectorWindow;
      
      private var _window:IWindowContainer;
      
      private var var_460:IFrameWindow;
      ...
      private function createWindow() : void
      {
         ...
         var_1399 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         update();
      }
      ...
      public function update() : void
      {
         ...
         if(var_47.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1397 == AvatarEditorSideCategory.WARDROBE || var_1639))
         {
            _loc4_ = "null";
         }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_460)
         {
            ...
            var_460 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_460.procedure = stripClubDialogEventProc;
            var_460.center();
         }
         else
         {
            var_460.visible = true;
            var_460.center();
         }
      }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_729:
               break;
            case AvatarEditorSideCategory.const_381:
               _loc3_ = var_47.getSideContentWindowContainer(AvatarEditorSideCategory.const_381);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_280 = param1;
         var_1399.setSelected(var_1399.getSelectableByName(param1));
         _window.invalidate();
      }
      
      private function toggleWardrobe() : void
      {
         if(var_1397 == AvatarEditorSideCategory.WARDROBE)
         {
            var_1639 = false;
