   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_34)
         {
            ...
            var_34["null"] = new AvatarEditorGridView(_model,FigureData.const_144,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(_model,FigureData.const_159,_windowManager,_assetLibrary);
         ...
         if(_model && var_143 == "")
         {
            _model.switchCategory(FigureData.const_144);
         }
      }
