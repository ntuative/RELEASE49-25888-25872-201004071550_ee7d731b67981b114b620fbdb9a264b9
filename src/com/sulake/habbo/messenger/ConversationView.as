package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1058:int = 20;
      
      private static const const_763:int = 100;
       
      
      private var var_1842:IScrollbarWindow;
      
      private var var_139:HabboMessenger;
      
      private var var_1473:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_139 = param1;
         var_1473 = initButton("follow_friend",onFollowButtonClick,param2);
         var_49 = IItemListWindow(param2.findChildByName("msg_list"));
         var_1842 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_731 || param3.type == Message.const_498 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_480.messages.length - const_763);
         _loc1_ = 0;
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_763 + const_1058)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_139.send(new FollowFriendMessageComposer(var_480.id));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_498)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1001)
         {
            return 4294927974;
         }
         if(param1 == Message.const_708)
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1057;
         param1.invalidate();
      }
   }
}
