package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_893:IButtonWindow;
      ...
      private var var_894:IDropMenuWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_895 = IButtonWindow(_main.getXmlWindow("modact_offence"));
         var_893 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_894.selection < 0)
         {
            _main.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         _main.connection.send(new ModBanMessageComposer(var_1312,var_430.text,getBanLength(),var_1311));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_894.selection;
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1312,var_430.text,var_1311));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_739 = _main.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1312,var_430.text,var_1311));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         {
            var_51.findChildByName("offence_txt").caption = this.var_740.name;
            var_51.findChildByName("offence_category").visible = true;
         }
         else if(this.var_739 != null)
         {
            this.refreshButtons("offences_cont",2,var_739.offences,var_895,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_893,onOffenceCtgButton);
      ...
      public function show() : void
      {
         ...
         var_51.caption = "Mod action on: " + var_1455;
         ...
         var_894 = IDropMenuWindow(var_51.findChildByName("banLengthSelect"));
         prepareBanSelect(var_894);
