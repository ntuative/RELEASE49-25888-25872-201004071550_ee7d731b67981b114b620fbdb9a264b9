package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_747:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_669,_data.flatId),var_51,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_411);
         if(param1.flatId != var_411)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_411);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_747.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1243,_loc2_,var_430.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1082.isSelected,var_1083.isSelected,var_747.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1377);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1221);
      }
      
      public function populate() : void
      {
         var_49 = IItemListWindow(var_51.findChildByName("list_cont"));
         ...
         var_747 = ICheckBoxWindow(var_51.findChildByName("kick_check"));
         var_1082 = ICheckBoxWindow(var_51.findChildByName("lock_check"));
         var_1083 = ICheckBoxWindow(var_51.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_411));
         Logger.log("BEGINNING TO SHOW: " + var_411);
      }
   }
}
