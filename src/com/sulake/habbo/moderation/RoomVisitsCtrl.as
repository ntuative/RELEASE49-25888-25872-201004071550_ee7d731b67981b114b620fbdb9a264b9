package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_2038:IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2038.clone());
      ...
      {
         var_2038 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
         ...
         var_49 = IItemListWindow(var_51.findChildByName("visits_list"));
