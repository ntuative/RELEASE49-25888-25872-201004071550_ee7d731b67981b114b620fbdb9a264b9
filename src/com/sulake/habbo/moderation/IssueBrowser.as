package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1598:IIssueBrowserView;
      
      private const const_1660:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1659:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1600:IIssueBrowserView;
      
      private const const_1664:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1661:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_241:ITabContextWindow;
      
      private var var_1599:PickedIssuesView;
      
      private var var_372:IIssueBrowserView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_241 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_241.numTabItems)
            {
               _loc5_ = var_241.getTabItemAt(_loc6_);
         ...
         var _loc1_:ISelectableWindow = var_241.selector.getSelectableByName("open_issues");
         var_241.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_372.view.width = var_241.container.width;
         var_372.view.height = var_241.container.height;
         var_372.visible = true;
         var_372.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1661:
               if(var_1600 == null)
               {
                  var_1600 = new MyIssuesView(issueManager,this,var_241.container);
               }
               return var_1600;
            case const_1660:
               if(var_1598 == null)
               {
                  var_1598 = new OpenIssuesView(issueManager,this,var_241.container);
               }
               return var_1598;
            case const_1659:
               if(var_1599 == null)
               {
                  var_1599 = new PickedIssuesView(issueManager,this,var_241.container);
               }
               return var_1599;
            default:
               return null;
