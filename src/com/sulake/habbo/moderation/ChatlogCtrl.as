package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1447:IMessageComposer;
      ...
      private var var_1333:Dictionary;
      ...
      {
         var_913 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_914 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         var_49 = IItemListWindow(var_51.findChildByName("chatline_list"));
         var_51.procedure = onWindow;
         var _loc1_:IWindow = var_51.findChildByTag("close");
         _loc1_.procedure = onClose;
         _main.connection.send(var_1447);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_913.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_914.clone());
         _loc4_.color = var_1333[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
