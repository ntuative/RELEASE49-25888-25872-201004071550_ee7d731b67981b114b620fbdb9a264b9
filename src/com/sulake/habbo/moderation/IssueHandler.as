package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_966:UserInfoCtrl;
      
      private var var_107:IssueBundle;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.releaseBundle(var_107.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = var_107.getHighestPriorityIssue();
         var_392 = new UserInfoCtrl(_window,var_56,_loc3_.message);
         var_966 = new UserInfoCtrl(_window,var_56,_loc3_.message);
         var_392.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_107.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_966.load(_loc4_,var_107.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.closeBundle(var_107.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc4_:Array = var_107.issues;
         var _loc5_:int = 0;
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = var_107.getHighestPriorityIssue().issueId;
         var_56.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_56,WindowTracker.const_937,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_56 != null && false && var_107 != null)
         {
            var_56.issueManager.removeHandler(var_107.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = var_107.getHighestPriorityIssue();
            var_392 = new UserInfoCtrl(_window,var_56,_loc3_.message);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.closeBundle(var_107.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.closeBundle(var_107.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      {
         return WindowTracker.const_1310;
      }
   }
}
