package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1342:int = 6;
      
      public static const const_669:int = 4;
      
      public static const TYPE_ROOMINFO:int = 9;
      
      public static const const_1250:int = 7;
      
      public static const const_937:int = 3;
      
      public static const const_1310:int = 8;
      
      public static const const_979:int = 5;
      
      public static const const_1176:int = 1;
      
      public static const const_1349:int = 2;
      ...
      {
         var_1411 = new Dictionary();
         super();
      }
      
      private function getWindowsForType(param1:int) : Dictionary
      {
         var _loc2_:Dictionary = var_1411[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1411[param1] = _loc2_;
         }
         return _loc2_;
      }
