package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_779:String = "selection_arrow";
      
      private static const const_778:String = "tile_cursor";
      
      private static const const_279:String = "RCL_PUBLICROOM_";
      ...
      private static const const_1109:String = const_351;
      ...
      private var var_1070:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         var_521 = [];
         var_520 = [];
         var_2123 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2122 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_424 = new Map();
         _events = new Map();
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_119 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         while(_loc5_ < _loc3_.length())
         {
            ...
            _loc7_ = const_279 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(var_174 != null && var_174.hasWorldType(const_279 + param1))
         {
            return var_174.type;
         }
         return param1;
      ...
      public function dispose() : void
      {
         ...
         if(var_424 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_424.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_359 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_359.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_424.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_604.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_424.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_351,const_493,ROOM_CONTENT,const_778,const_779];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2123.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_169 && _loc5_ != RoomObjectLogicEnum.const_119)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_522.getValue(param1) as String;
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return var_603.getValue(param1);
         }
         return "";
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_425 != null)
         {
            _loc2_ = var_425.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1161);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2122.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_448,_loc5_);
         }
      ...
      private function continueInitilization() : void
      {
         if(var_2128)
         {
            ...
            if(var_1070 != null)
            {
               var_1070.dispatchEvent(new Event(const_716));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_174 != null)
         {
            return var_174.getWorldHeightScale(const_279 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1070 = param1;
            var_2127 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2125 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2124 = param2.getKey("public.room.dynamic.download.url","");
            var_2126 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_31 = const_780;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_359.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_169 && _loc5_ != RoomObjectVisualizationEnum.const_119)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_442.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_279 + param1) == RoomObjectCategoryEnum.const_61)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            var_174 = var_1295.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_174 != null)
         {
            return var_174.getWorldScale(const_279 + param1);
         }
         return 32;
      }
