package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_921);
         addPlane(RoomPlaneData.const_143,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            addPlane(RoomPlaneData.const_143,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + var_115) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            addPlane(RoomPlaneData.const_143,Vector3d.sum(param1,Vector3d.product(param3,-var_115 / param3.length)),Vector3d.product(param3,(param3.length + var_115) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_921 / param2.length);
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         var_762 = getFloorHeight(var_102);
         if(!param1)
         {
            createWallPlanes();
         }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            ...
            {
               if(param1 == var_367 || param1 == var_370)
               {
                  _loc5_ = false;
                  _loc6_ = var_368;
               ...
               if(param2 == var_368 || param2 == var_369)
               {
                  _loc7_ = false;
                  _loc8_ = var_367;
      ...
      {
         var _loc12_:RoomPlaneData = addPlane(RoomPlaneData.const_145,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_145,_loc13_,new Vector3d(0,0,-var_115),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_145,_loc13_,new Vector3d(0,0,-var_115),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_145,_loc13_,new Vector3d(0,0,-var_115),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_145,_loc13_,new Vector3d(0,0,-var_115),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
