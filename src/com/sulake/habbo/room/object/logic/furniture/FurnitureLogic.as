package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               {
                  _loc2_.setString(RoomObjectVariableEnum.const_398,String(_loc3_.extra));
               }
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            if(_loc2_ != null)
            {
               _loc2_.setString(RoomObjectVariableEnum.const_889,_loc4_.itemData);
            }
            return;
         }
         var_700 = false;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         object.getModelController().setNumber(RoomObjectVariableEnum.const_292,var_1037,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_396,var_1036,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_711,var_1035,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1344,var_2001,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1159,var_2000,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1008,var_1243,true);
         object.getModelController().setNumberArray(RoomObjectVariableEnum.const_703,var_222,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_201,1);
      }
