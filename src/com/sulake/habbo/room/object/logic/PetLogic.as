         ...
         if(object != null)
         {
            ...
            if(object.getType() == "pet")
            {
               if(param1 is RoomObjectAvatarUpdateMessage)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     _loc2_.setNumber(RoomObjectVariableEnum.const_316,_loc3_.dirHead);
                  }
               }
               if(param1 is RoomObjectAvatarFigureUpdateMessage)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_1268,_loc4_.race);
               }
               if(param1 is RoomObjectAvatarWaveUpdateMessage)
               {
                  ...
                  if(_loc6_.isWaving)
                  {
                     _loc2_.setNumber(RoomObjectVariableEnum.const_328,new Date().valueOf());
                  }
                  else
                  {
               ...
               if(param1 is RoomObjectAvatarSleepUpdateMessage)
               {
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_378,Number(_loc7_.isSleeping));
               }
               if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
               {
                  _loc8_ = param1 as RoomObjectAvatarPetGestureUpdateMessage;
                  _loc2_.setString(RoomObjectVariableEnum.const_390,_loc8_.gesture);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_388,getTimer());
               }
               if(param1 is RoomObjectAvatarChatUpdateMessage)
               {
                  _loc9_ = param1 as RoomObjectAvatarChatUpdateMessage;
                  _loc2_.setNumber(RoomObjectVariableEnum.const_505,_loc9_.numberOfWords);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_636,new Date().valueOf());
               }
               ...
               if(param1 is RoomObjectAvatarExperienceUpdateMessage)
               {
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_878,Number(_loc12_.gainedExperience));
               }
            }
         }
      }
