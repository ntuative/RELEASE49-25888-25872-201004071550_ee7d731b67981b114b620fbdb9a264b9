package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1465:int = 1500;
      
      private var var_1466:int = 255;
      
      private var var_1464:int = 255;
      
      private var var_1178:uint = 16777215;
      
      private var var_990:uint = 16777215;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_585:
                  _loc2_.setString(RoomObjectVariableEnum.const_707,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_675:
                  _loc2_.setString(RoomObjectVariableEnum.const_536,_loc3_.value);
                  break;
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_479:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_221)
                  {
                     _loc8_ = "null";
                  }
                  var_382.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_546:
                  _loc7_ = var_382.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_382.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_975,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_811,int(_loc5_.bgOnly));
            var_1178 = _color;
            var_1466 = var_1340;
            var_990 = _loc11_;
            var_1464 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_798,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_710,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1249,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1289,_loc21_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_145)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_143 || _loc13_ == RoomPlaneData.const_262)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_816)
         {
            ...
            {
               _loc7_ = var_1178 >> 16 & 255;
               _loc8_ = var_1178 >> 8 & 255;
               _loc9_ = var_1178 & 255;
               _loc10_ = var_990 >> 16 & 255;
               _loc11_ = var_990 >> 8 & 255;
               _loc12_ = var_990 & 255;
               _loc13_ = (_loc2_ - var_816) / var_1465;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1466 + (var_1464 - var_1466) * _loc13_;
               _color = _loc3_;
               var_1340 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_710,_loc3_);
         }
      }
   }
}
