package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_2283:Number = NaN;
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            var_577[param1] = _loc3_;
            var_578[param1] = _loc4_;
         }
         if(_loc4_)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2284,param1);
      ...
      {
         var _loc3_:int = 0;
         if(var_1915 != param1 || var_1914 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_577[_loc3_] = "";
               var_578[_loc3_] = false;
               _loc3_--;
            }
            var_1915 = param1;
            var_1914 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_1913 != param1 || var_1912 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2284 = _loc3_.getNumber(RoomObjectVariableEnum.const_231);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_201));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            var_1423 = _loc3_.getString(RoomObjectVariableEnum.const_337);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_288 != _loc3_.getUpdateID() || param1 != var_209 || param2 != var_2283)
         {
