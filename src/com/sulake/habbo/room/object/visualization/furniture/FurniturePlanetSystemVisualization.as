package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_825);
      ...
      {
         if(param1 < var_606.length)
         {
            return var_606[param1].y;
         }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_231 != null)
         {
            ...
            {
               _loc2_ = var_231[_loc3_];
               _loc2_.update(var_606,var_2132,param1);
               _loc3_++;
            }
