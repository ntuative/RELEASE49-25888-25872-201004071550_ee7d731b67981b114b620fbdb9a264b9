package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = var_312.getWithIndex(_loc1_) as PlaneVisualization;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_719 = var_312.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_719 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_312 != null)
         {
            ...
            {
               _loc1_ = var_312.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
