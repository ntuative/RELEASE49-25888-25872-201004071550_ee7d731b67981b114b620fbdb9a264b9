package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1383:int = 13421772;
      
      private static const const_747:int = 16777215;
      
      public static const const_1173:int = 10066329;
      
      private static const const_748:int = 13421772;
      
      public static const const_1154:int = 16777215;
      
      private static const const_1408:int = 0;
      
      public static const const_1206:int = 16777215;
      
      private static const const_746:int = 10066329;
      
      private static const const_745:int = 10066329;
      ...
      private var var_1652:int = 255;
      
      protected var _data:RoomVisualizationData = null;
      
      private var _assetLibrary:AssetLibrary = null;
      
      private var var_1365:String = null;
      
      private var var_1653:int = -1000;
      
      private var var_959:uint = 16777215;
      ...
      private var var_553:Rectangle = null;
      
      private var var_1654:int = 255;
      
      private var var_1648:Boolean = false;
      
      private var var_1649:int = 255;
      
      private var var_1651:String = null;
      
      private const const_1630:int = 250;
      ...
      private var var_382:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         var_382 = new RoomPlaneBitmapMaskParser();
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_798);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_807);
         var _loc7_:int = 0;
         while(_loc7_ < var_73.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_145)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_143)
            {
               ...
               {
                  _loc13_.color = const_745;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_747;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_748;
               }
               else
               {
                  _loc13_.color = const_746;
               }
               if(_data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1364)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_202,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_553 == null)
         {
            var_553 = super.boundingRectangle;
         }
         return new Rectangle(var_553.x,var_553.y,var_553.width,var_553.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_382.maskCount)
         {
            _loc6_ = var_382.getMaskType(_loc5_);
            _loc7_ = var_382.getMaskLocation(_loc5_);
            _loc8_ = var_382.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_101.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_202 || _loc3_.type == RoomPlane.const_182 && _loc8_ == RoomPlaneBitmapMaskData.const_221)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1403;
                        if(var_73.getPlaneType(_loc9_) == RoomPlaneData.const_145)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1303)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_1074 || _loc9_.y != var_1650 || _loc9_.z != var_1656 || param1.scale != var_1647))
            {
               var_1074 = _loc9_.x;
               var_1650 = _loc9_.y;
               var_1656 = _loc9_.z;
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_975);
            if(_loc10_ != var_1651)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_710));
            if(_loc11_ != var_959)
            {
               var_959 = _loc11_;
               var_1649 = var_959 & 255;
               var_1654 = var_959 >> 8 & 255;
               var_1652 = var_959 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1653 + const_1630 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1653 = _loc7_;
         if(var_161 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_536);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_707);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_735);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1655 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_811));
         ...
         while(_loc8_ < var_381.length)
         {
            ...
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_182)
            {
               if(var_1655)
               {
                  ...
                  _loc19_ = uint((_loc18_ & 255) * var_1649 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1654 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1652 / 255);
