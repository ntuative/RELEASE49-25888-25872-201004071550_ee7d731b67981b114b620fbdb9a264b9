package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1380:int = const_314;
      ...
      public static const const_562:int = 6;
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(false)
         {
            _loc4_ = var_332[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1420 == const_102)
         {
            _loc5_ = new Rectangle(0,0,var_23.width,var_331);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_331,var_23.width,var_331);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_23 != null)
            {
               if(var_23.width == param2 && var_23.height == param3 && Vector3d.isEqual(var_559,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_331,param6,param7);
                     return param1;
                  }
                  return var_23;
               }
         ...
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < var_332.length)
         {
            _loc11_ = var_332[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      public function clearCache() : void
      {
         ...
         if(var_559 != null)
         {
            var_559.assign(new Vector3d());
         }
         var_331 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < var_332.length)
         {
            _loc2_ = var_332[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= var_332.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = var_332[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         var_332[param1] = _loc5_;
