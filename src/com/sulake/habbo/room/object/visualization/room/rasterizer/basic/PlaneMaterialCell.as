package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_481:PlaneTexture;
      ...
      public function render(param1:IVector3d) : BitmapData
      {
         ...
         if(var_481 != null)
         {
            _loc2_ = var_481.getBitmap(param1);
            if(_loc2_ != null)
            {
               if(!isStatic)
               {
                  ...
                  _loc3_ = Math.min(var_998,_extraItemOffsets.length);
                  _loc4_ = Math.max(var_998,_extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(var_998,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = _extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = var_677[_loc6_ % 0] as IGraphicAsset;
