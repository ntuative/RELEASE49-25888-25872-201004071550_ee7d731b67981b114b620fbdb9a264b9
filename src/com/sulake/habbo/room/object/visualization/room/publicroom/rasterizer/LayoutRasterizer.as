package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1002:Point = null;
      
      private var var_483:Array;
      
      private var var_1003:LayoutRasterizerData = null;
      ...
      private var var_882:IGraphicAssetCollection;
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1199 = RoomObjectVariableEnum.const_1002;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1199 = RoomObjectVariableEnum.const_1022;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1004 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1004 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_1004 + _adBgIndex);
            _loc5_ = param1.getSprite(var_1004 + _adImgIndex);
         }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1861);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_679)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1003 = var_38.getValue(var_679);
         }
      }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_1003.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = var_882.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_1002.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_1002.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_344.indexOf(_loc10_) >= 0 && var_482)
            {
               param1 = var_344.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = var_882.getAsset(var_484[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
