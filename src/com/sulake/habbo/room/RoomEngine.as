package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_276:String = "object_icon_sprite";
      ...
      private static const const_1045:String = "tile_cursor";
      
      private static const const_277:int = -1;
       
      
      private var var_442:IRoomObjectVisualizationFactory = null;
      ...
      private var var_254:IAdManager = null;
      
      private var var_560:NumberBank;
      ...
      private var var_658:RoomMessageHandler = null;
      
      private var var_657:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_292 = new Map();
         var_560 = new NumberBank(1000);
         var_967 = new Map();
         var_293 = new Map();
         var_63 = new RoomObjectEventHandler(this);
         var_658 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_63 != null)
         {
            ...
            {
               return var_63.deleteWallItem(var_108,var_109,param1);
            }
         }
         return false;
      }
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_660) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_597) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_564) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_630) + 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_63 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_29)
            {
               return var_63.modifyWallItemData(var_108,var_109,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_442 != null)
         {
            var_442.release(new IIDRoomObjectVisualizationFactory());
            var_442 = null;
         }
         if(var_39 != null)
         {
         ...
         if(var_657 != null)
         {
            var_657.release(new IIDRoomRendererFactory());
            var_657 = null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_657.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_916;
         ...
         {
            _loc12_ = method_2(param1,param2);
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_639);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_538);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_691);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_822);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_868);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_894) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_895);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_479,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_546,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_654,var_108,var_109,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_63 != null)
         {
            return var_63.modifyRoomObject(var_108,var_109,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_675,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_740,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_39 != null)
         {
            ...
            var_39.addObjectUpdateCategory(RoomObjectCategoryEnum.const_61);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_63 != null)
         {
            var_63.handleRoomObjectEvent(param1,var_108,var_109);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_231,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_298,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_337,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_910,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_879,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_914,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_270,param1,param2,param3,RoomObjectCategoryEnum.const_31));
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         var _loc9_:IRoomInstance = createRoom(_loc4_,param3,_loc6_,_loc7_,_loc8_,method_2(param1,param2));
         if(_loc9_ == null)
         {
            return;
         }
      ...
      {
         if(var_26 == null || var_442 == null || var_39 == null || var_657 == null || _communication == null || _habboConfiguration == null || !var_1726)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_277,RoomObjectCategoryEnum.const_61);
      }
      ...
      {
         var _loc13_:* = null;
         var _loc10_:String = method_2(param1,param2);
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1232,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_39.getRoom(getRoomIdentifier(var_108,var_109));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_756,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_109,var_1144);
         if(_loc2_ != null)
         {
            _loc3_ = getOverlaySprite(_loc2_);
            _loc4_ = getOverlayIconSprite(_loc3_,const_276);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_109,var_1144);
         if(_loc1_ != null)
         {
            _loc2_ = getOverlaySprite(_loc1_);
            removeOverlayIconSprite(_loc2_,const_276);
         }
      }
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_442 = param2 as IRoomObjectVisualizationFactory;
         if(var_11 != null)
         {
            var_11.visualizationFactory = var_442;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_26 != null)
         {
            if(false)
            {
               var_26.events.addEventListener(RoomObjectMouseEvent.const_209,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMouseEvent.const_424,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_247,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_556,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_129,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_469,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_461,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_366,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_394,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectMoveEvent.const_365,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMoveEvent.const_370,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_264,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_386,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_304,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_301,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_387,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_964,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_374,roomObjectEventHandler);
               var_26.events.addEventListener(AvatarWalkWarpingWarningEvent.const_362,warningEventHandler);
            }
         }
      }
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         ...
         return RoomObjectCategoryEnum.const_193;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(var_63 != null)
         {
            return var_63.initializeRoomObjectInsert(var_108,var_109,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_467 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_540,0,0));
            _loc2_ = 0;
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_270,param1,param2,param3,RoomObjectCategoryEnum.const_36));
         }
         return true;
      }
      ...
      public function method_2(param1:int, param2:int) : String
      {
         var _loc3_:RoomInstanceData = getRoomInstanceData(param1,param2);
         if(_loc3_ != null)
         {
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_29:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_231));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_398);
                     break;
                  case RoomObjectCategoryEnum.const_36:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_152);
               }
            }
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_716)
         {
            var_1726 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_231,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_298,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_337,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_916,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_270,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_254.events.addEventListener(AdEvent.const_373,showRoomAd);
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_657 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_467 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_39.getRoom(const_482);
         if(_loc10_ == null)
         {
            _loc10_ = var_39.createRoom(const_482,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_560.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_31:
            case RoomObjectCategoryEnum.const_29:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_231,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_398,param8);
               break;
            case RoomObjectCategoryEnum.const_36:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_152,param2);
               break;
            case RoomObjectCategoryEnum.const_61:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_145,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_707,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_536,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_735,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_479,_loc24_,param6,new Vector3d(2,0,1.75));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_757,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            _loc11_ = getOverlayIconSprite(_loc10_,const_276);
            if(_loc11_ != null)
            {
               _loc12_ = _loc11_.getRect(_loc11_);
               _loc11_.x = var_1429 - _loc12_.width / 2;
               _loc11_.y = var_1428 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_475,var_108,var_109,-1,RoomObjectCategoryEnum.const_193));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_63 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_277,const_483);
                  var_63.handleRoomObjectEvent(_loc14_,var_108,var_109);
               }
            }
         }
      }
      ...
      {
         return isPublicRoomWorldType(method_2(param1,param2));
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_109,var_1144);
         if(_loc7_ != null)
         {
            _loc10_ = getOverlaySprite(_loc7_);
            removeOverlayIconSprite(_loc10_,const_276);
            _loc11_ = addOverlayIconSprite(_loc10_,const_276,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = var_1429 - _loc6_.data.width / 2;
               _loc11_.y = var_1428 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_11 != null)
         {
            _loc2_ = method_2(param1.roomId,param1.roomCategory);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_310,param1.image,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1002,param1.adWarningL,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1022,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_932,RoomObjectVariableEnum.const_310,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_11 != null)
         {
            _events.addEventListener(RoomContentLoader.const_716,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_63 != null)
         {
            var_63.cancelRoomObjectInsert(var_108,var_109);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_39.getRoom(const_482);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               var_560.freeNumber(_loc10_ - 1);
               _loc13_ = var_967.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_108,var_109,const_277,RoomObjectCategoryEnum.const_61,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_277,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_984,param6,true);
            ...
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_900,_loc13_,true);
            if(var_11 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_277,const_483,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_618,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_639,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_660,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_564,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_597,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_630,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_807,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_675,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_740,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_479,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_221);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_538,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_691,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_538,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_691,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_822,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_868,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_757,const_1045,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         _loc7_.createRoomObject(const_756,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         return _loc7_;
      }
