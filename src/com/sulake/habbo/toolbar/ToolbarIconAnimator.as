package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         {
            var_805 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_804.push(new XML());
               var_806.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_806[var_51] = param6.clone();
         }
      ...
      {
         if(var_1166 == true || var_664 == 0)
         {
            if(false)
            {
               ++var_51;
               if(var_51 >= var_804.length)
               {
                  var_51 = 0;
                  ++var_664;
               }
      ...
      {
         return var_804.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1166 == false && var_664 == 1 && var_1152 != var_31;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_805 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_805.width),Math.max(param2.height,var_805.height));
            _loc3_.copyPixels(var_805,var_805.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_51 <= var_806.length)
         {
            _loc2_ = var_806[var_51];
