package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_758:int = 50;
      
      private static const const_1047:Number = 25;
      
      private static const const_1046:int = 50;
      ...
      private var var_971:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_971 = param2;
         var_563 = new Timer(const_1047);
         var_563.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_469.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_469.splice(_loc3_,1);
            var_468.splice(_loc3_,1);
         }
         var_468.push(param1.name);
         var_469.push(param2);
         param1.addEventListener(WindowEvent.const_458,windowEventListener);
         param1.addEventListener(WindowEvent.const_219,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_469[var_468.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_971.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_971.getIconLoc(param1.iconId);
      ...
      {
         return var_468[var_469.indexOf(param1)];
      }
      ...
      {
         return param1.x + param1.width < const_758 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_758 || param1.desktop.height - param1.y < const_1046;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_468.length)
         {
            if(var_468[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
