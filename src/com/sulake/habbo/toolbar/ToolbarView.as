package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_202 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_59,HabboWindowStyle.const_943,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1085 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1085)
         {
         ...
         var_1326 = _loc7_.toolbar.@margin_bottom;
         var_1568 = _loc7_.toolbar.@min_group_margin;
         var_1569 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_274,param1,param2,_window,var_258);
         createGroupsFromXmlList(_loc9_,var_615,param1,param2,var_202,var_258);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_137,var_532,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1568,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1326) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1568,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1326) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_137,var_532);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_615.length)
         {
            _loc2_ = var_615[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_532);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_137,var_532);
         }
      }
