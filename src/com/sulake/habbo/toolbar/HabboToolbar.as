package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_819,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_154,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_168,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_48,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_399,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_704,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1004,onHideWindowEvent);
         var_31 = true;
