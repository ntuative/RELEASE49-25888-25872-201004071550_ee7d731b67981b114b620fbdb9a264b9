package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_226:LatencyTracker = null;
      ...
      private var var_153:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_1063:int = -1;
      
      private var var_869:LagWarningLogger = null;
      
      private var var_870:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_226 = new LatencyTracker();
         var_869 = new LagWarningLogger();
         var_1285 = new Array(const_773);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1301,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_713,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1024,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1254);
               break;
            case HabboCommunicationEvent.const_519:
               trackLoginStep(HabboLoginTrackingStep.const_1223,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_230:
               trackLoginStep(HabboLoginTrackingStep.const_230);
               break;
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_226 != null)
            {
               var_226.communication = _communication;
               var_226.connection = param1;
            }
            if(var_869 != null)
            {
               var_869.connection = param1;
            }
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_151)
         {
            Component(var_151).events.addEventListener(HabboConfigurationEvent.const_153,onConfigurationLoaded);
            if(var_226 != null)
            {
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_254.events.addEventListener(AdEvent.const_373,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_2081)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1369);
            var_2081 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1024,String(_loc2_.guestRoomId));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_519,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_230,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_665,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_64,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_466,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_362:
               var_869.warpingDetected();
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_870)
            {
               var_870.release(new IIDHabboWindowManager());
               var_870 = null;
            }
            if(var_254)
            {
            ...
            if(var_172)
            {
               if(true)
               {
                  ...
                  Component(var_172).events.removeEventListener(HabboFriendListTrackingEvent.const_315,onFriendlistTrackingEvent);
               }
            ...
            if(var_153)
            {
               if(true)
               {
                  var_153.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_153.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_153.release(new IIDHabboHelp());
               var_153 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_362,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_153);
         if(var_151)
         {
            if(var_869 != null)
            {
               var_869.configure(var_151);
            }
            Component(var_151).events.removeEventListener(HabboConfigurationEvent.const_153,onConfigurationLoaded);
         }
      }
      ...
      {
         var_153 = param2 as IHabboHelp;
         var_153.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_153.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_829);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_829,onCoreRunning);
         }
      }
      ...
      {
         var_870 = IHabboWindowManager(param2);
         if(var_870)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1063 > -1 && _loc2_ < var_1063)
         {
            ++var_1530;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1530);
         }
         if(var_1063 > -1 && _loc2_ - var_1063 > 15000)
         {
            ++var_1529;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1529);
         }
         var_1063 = _loc2_;
         if(var_225 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_362,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_264,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_172).events.addEventListener(HabboFriendListTrackingEvent.const_315,onFriendlistTrackingEvent);
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_665)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1235);
         }
         else if(param1.type == HabboHotelViewEvent.const_466)
         {
