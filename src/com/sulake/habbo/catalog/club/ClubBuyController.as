package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyController
   {
      ...
      private var var_186:ClubBuyConfirmationDialog;
      ...
      {
         closeConfirmation();
         var_186 = new ClubBuyConfirmationDialog(this,param1,param2);
      }
      ...
      public function getClubType() : int
      {
         ...
         {
            _loc1_ = !!_catalog.getPurse().isVIP ? 0 : int(HabboClubLevelEnum.const_55);
         }
         return _loc1_;
      }
      ...
      public function onOffers(param1:HabboClubOffersMessageEvent) : void
      {
         ...
         var_596.sort(orderByPrecedence);
         for each(_loc6_ in var_596)
         {
