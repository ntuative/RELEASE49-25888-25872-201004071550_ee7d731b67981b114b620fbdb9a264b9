package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      private var var_284:IBitmapWrapperWindow;
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(var_284 != null && true)
         {
            ...
            var_284.bitmap = new BitmapData(var_284.width,var_284.height,true,16777215);
            var_284.bitmap.fillRect(var_284.bitmap.rect,16777215);
            _loc3_ = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
            var_284.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         }
      ...
      {
         var _loc8_:* = null;
         var_284 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
