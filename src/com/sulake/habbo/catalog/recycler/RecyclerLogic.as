package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_791:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1589)
         {
            case RecyclerStatusMessageEvent.const_1281:
               var_283 = const_352;
               if(_view == null)
               {
                  return;
            ...
            case RecyclerStatusMessageEvent.const_1012:
               ...
               break;
            case RecyclerStatusMessageEvent.const_1317:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1589 != RecyclerStatusMessageEvent.const_1012;
      }
      
      private function get statusActive() : Boolean
      {
         return var_283 != const_791;
      }
      ...
      {
         return active && var_283 == const_352;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1007:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1242:
