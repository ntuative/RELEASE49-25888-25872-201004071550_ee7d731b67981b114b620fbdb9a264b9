package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_298:CatalogViewer;
      
      private var var_1805:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_395:ICatalogNavigator;
      ...
      private var var_1806:GiftWrappingConfiguration;
      ...
      private var var_986:ClubGiftController;
      ...
      {
         return var_358.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_111.credits = _loc3_.balance;
         updatePurse();
         if(!var_1804 && var_477 != null)
         {
            var_477.playSound(HabboSoundTypesEnum.const_833);
         }
         var_1804 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_358.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_82)
         {
            _loc3_ = var_358.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_93:
               var_1173 = param1.session.isPrivateRoom;
               if(var_79 != null)
               {
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_151.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_151.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1806 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_212,false);
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_986.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_395 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_111.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_111.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         var_111.isVIP = _loc2_.isVIP;
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_986 == null)
         {
            var_986 = new ClubGiftController(this);
         }
      }
      ...
      {
         var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_395.buildCatalogIndex(_loc2_);
         if(var_987 != "")
         {
            var_395.openPage(var_987);
            var_987 = "";
         }
         else
         {
            var_395.openFrontPage();
         }
      }
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_163)
         {
            _loc3_ = var_151.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(param1 == null || var_298 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_298.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_111.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_111.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_111.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_111.clubPeriods));
         var _loc1_:IIconWindow = _mainContainer.findChildByName("clubIcon") as IIconWindow;
         if(_loc1_)
         {
            if(false)
            {
               _loc1_.style = HabboIconType.const_632;
            }
            else
            {
               _loc1_.style = HabboIconType.const_633;
            }
         }
         if(false)
         {
         ...
         var _loc2_:IWindowContainer = _mainContainer.findChildByName("clubContainer") as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.findChildByName("clubText") as ITextWindow;
            if(_loc3_ != null)
            {
               _loc3_.caption = _localization.getKey("catalog.purse.club.join");
            }
         }
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_298.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_111.pixels = _loc2_.amount;
         updatePurse();
         if(!var_1805 && var_477 != null)
         {
            var_477.playSound(HabboSoundTypesEnum.const_999);
         }
         var_1805 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_298.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_298.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_298 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_298.habboCatalog = this;
      }
