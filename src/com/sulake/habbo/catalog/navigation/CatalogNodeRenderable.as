package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1069:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1498:XML;
      ...
      private var var_1497:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1498 == null)
         {
            ...
            var_1498 = _loc4_.content as XML;
         }
         if(var_1496 == null)
         {
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1497 == 4294967295)
            {
               var_1497 = _loc1_.color;
            }
            _loc1_.color = const_1069;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1141;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1498) as IWindowContainer;
         }
         else
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1227;
            }
         }
      }
