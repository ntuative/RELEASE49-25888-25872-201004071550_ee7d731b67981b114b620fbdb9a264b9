package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_190:Dictionary = new Dictionary();
      ...
      private static const const_795:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      ...
      private static const const_1131:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      
      {
         const_190["frontpage3"] = ["ctlg_txt3","ctlg_txt7"];
         const_190["info_pixels"] = ["ctlg_text_5","ctlg_text_7"];
         const_190["info_credits"] = ["ctlg_text_5","ctlg_text_7"];
         const_190["collectibles"] = ["ctlg_collectibles_link"];
         const_190["club1"] = ["ctlg_text_5"];
      }
      ...
      {
         if(param1 < var_632.length)
         {
            return var_632[param1];
         }
         return "";
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < var_632.length)
         {
            _loc2_ = String(var_632[param1]).replace("#","0x");
