package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1308:XML;
      
      private var var_319:IGridItem;
      
      private var var_1309:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_891:PrizeViewer;
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            createLevelItem(var_738[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_891 = new PrizeViewer();
         var_738 = recycler.getPrizeTable();
         if(var_738 == null)
         {
            return;
         }
         ...
         var_1308 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_738[0].prizes.length > 0)
         {
            select(var_738[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1308) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1309) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_891.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
