package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_925:MarketPlaceOfferData;
      
      private const const_1435:int = 1;
      
      private const const_1658:int = 40;
      
      private var var_540:IWindowContainer;
      
      private const const_1436:int = 2;
      ...
      private function updateList() : void
      {
         ...
         updateStatusDisplay(const_1436,_loc2_.length);
         if(!var_444)
         {
            var_444 = new Timer(25);
            var_444.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_926 = 0;
         populateList();
         var_444.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_596)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1435);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_443.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_444)
         {
            var_444.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_444 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_926 >= var_596.length)
            {
               return true;
            }
            addListItem(var_596.getWithIndex(var_926));
            ++var_926;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_925.offerId);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_136)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_443));
            _loc7_.selection = 0;
         }
      }
