package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1100:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1099 != null)
         {
            var_1099.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1100 != null)
         {
            var_1100.removeEventListener(WindowKeyboardEvent.const_134,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1099 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1099 != null)
         {
            var_1099.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1100 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1100 != null)
         {
            var_1100.addEventListener(WindowKeyboardEvent.const_134,windowKeyEventProcessor);
         }
      }
