package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_584[var_1028] as Array;
      ...
      {
         var _loc2_:Offer = var_584[var_1028][var_1984];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_478 || _loc1_.pricingModel == Offer.const_473)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_82 || _loc3_.productType == ProductTypeEnum.const_77)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_1029.indexOf(_loc5_) == -1)
                        {
                           var_1029.push(_loc5_);
                           var_584.push(new Array());
                        }
                        _loc6_ = var_1029.indexOf(_loc5_);
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_584)
         {
            if(var_1984 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1984] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1028 = var_951.getGridItemIndex(param1.view);
