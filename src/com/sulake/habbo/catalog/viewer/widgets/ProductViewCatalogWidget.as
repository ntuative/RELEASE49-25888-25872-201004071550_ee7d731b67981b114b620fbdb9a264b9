package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1477:Point;
      
      private var var_1858:Array;
      
      private var var_567:IItemGridWindow;
      
      private var var_80:IBitmapWrapperWindow;
      
      private var var_1191:ITextWindow;
      
      private var var_1196:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_567 != null)
         {
            var_567.visible = false;
            var_567.destroyGridItems();
         }
         if(var_1196 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1191.text = "${" + _loc3_.name + "}";
            var_1190.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1191.text = "${" + _loc2_.localizationId + "}";
            var_1190.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            {
               case Offer.const_449:
                  _loc4_ = var_1195.clone();
                  if(var_567 != null)
                  {
                     var_567.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_567,var_1196,var_1309);
                  }
                  break;
               ...
               case Offer.const_473:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_210:
                        ...
                        _loc4_ = new BitmapData(var_80.width,var_80.height,false,_loc10_);
                        _loc11_ = null;
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_331,AvatarAction.const_517);
                              _loc13_.appendAction(AvatarAction.const_666,_loc6_.productClassId);
      ...
      {
         var_1191 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1190 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_80 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1477 = new Point(var_80.x,var_80.y);
         var_567 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1196 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_567 == null)
         {
         ...
         var_1195 = _loc2_.content as BitmapData;
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(var_80);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(var_80 != null && true)
         {
            ...
            if(true)
            {
               var_80.bitmap = new BitmapData(var_80.width,var_80.height,true,16777215);
            }
            var_80.bitmap.fillRect(var_80.bitmap.rect,16777215);
            _loc4_ = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
            var_80.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            var_80.invalidate();
            var_80.x = var_1477.x;
            var_80.y = var_1477.y;
            if(param3 != null)
