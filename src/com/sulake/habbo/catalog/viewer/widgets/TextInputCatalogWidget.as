package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_956 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_956 != null)
         {
            var_956.addEventListener(WindowKeyboardEvent.const_650,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_956.text));
      }
   }
}
