package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:Map = var_383.getWithIndex(var_183);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(var_461);
            if(_loc3_ == null)
            {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(var_80 != null)
         {
            ...
            var_80.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
            var_80.invalidate();
         }
      ...
      override public function init() : void
      {
         ...
         var _loc8_:* = null;
         super.init();
         var_80 = window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(var_383.getValue(_loc6_) == null)
            {
               var_383.add(_loc6_,new Map());
            }
            _loc8_ = var_383.getValue(_loc6_) as Map;
            _loc8_.add(_loc7_,_loc3_);
         }
         _loc4_ = var_383.getWithIndex(var_183);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(var_461);
            if(_loc3_ == null)
            {
