package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1407:String = "ctlg_";
      ...
      private var var_1373:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_891:ICatalogViewer;
      ...
      {
         var _loc2_:String = const_1407 + param1;
         ...
         var_1394 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1394) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_933);
      }
      ...
      private function createWidgets() : void
      {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1373;
            _loc2_.init();
         }
         var_1373.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1373.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_933);
      }
