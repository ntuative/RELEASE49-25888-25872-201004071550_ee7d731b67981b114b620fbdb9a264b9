package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1593:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_387 != null)
         {
            if(var_387.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_387.window);
            var_387.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1593);
         var_387 = _loc5_;
      ...
      {
         return var_387.dispatchWidgetEvent(param1);
      }
