package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogObjectMover implements IGetImageListener
   {
      ...
      private static const const_345:String = "CatalogOverlaySprite";
      ...
      private function releaseOverlaySprite() : void
      {
         ...
         var _loc2_:Sprite = _loc1_.getChildByName(const_345) as Sprite;
         if(_loc2_ == null)
         {
            return;
         }
         _loc2_.removeChildAt(0);
         _loc1_.removeChild(_loc1_.getChildByName(const_345));
      }
      ...
      private function getIconSprite() : Sprite
      {
         ...
         var _loc1_:Sprite = _mainContainer.desktop.getDisplayObject() as Sprite;
         return _loc1_.getChildByName(const_345) as Sprite;
      }
