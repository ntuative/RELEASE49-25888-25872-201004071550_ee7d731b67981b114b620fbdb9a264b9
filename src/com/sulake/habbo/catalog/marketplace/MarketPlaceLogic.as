package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1665:int = 3;
      
      public const const_1603:int = 2;
      ...
      private var var_1903:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1574,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1808 || param1.furniTypeId != var_1807)
         {
            return;
         }
         var_1903 = param1;
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = var_189.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1603,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = var_189.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = var_189.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_410)
            {
               var_189.remove(_loc2_);
               _loc3_.dispose();
            }
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1904 = _loc3_.creditsWaiting;
         var_189 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_189.add(_loc4_.offerId,_loc6_);
         }
      ...
      {
         requestOffers(var_1906,var_1905,var_1760,var_1907);
      }
