package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_1038 + var_1038 / -var_2359 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_850 - var_850 / var_416 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc5_ = Math.pow(10,int(var_416).toString().length - 1);
         var_416 = Math.ceil(var_416 / _loc5_) * _loc5_;
         ...
         _loc6_.text = var_416.toString();
         _loc3_.draw(_loc6_);
         var_1038 = param1 - _loc6_.textWidth - 2;
         var_850 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,var_850);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (var_850 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(var_1038 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_1038,(param2 - var_850) / 2));
         return _loc3_;
      }
