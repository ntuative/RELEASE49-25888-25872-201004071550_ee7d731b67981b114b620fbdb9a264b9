package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1423:uint = 4.293848814E9;
      
      private var var_877:int;
      
      private const const_1652:uint = 4.291613146E9;
      ...
      private const const_1653:int = 10;
      ...
      private function checkboxHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_593:
               showSelectors(false);
               break;
            case WindowEvent.const_638:
               showSelectors(true);
         }
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_230.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_876;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_876,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1423) : uint(const_1424);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_387,var_77,var_1069);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_230.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_876);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_600[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_599[var_199]);
         _catalog.purchaseProductAsGift(var_387,var_77,var_1069,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_136:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(var_2103 == _loc3_.text)
               {
                  return;
               }
               ...
               for each(_loc7_ in var_227)
               {
                  ...
                  if(_loc5_.length >= const_1653)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_2103 = _loc3_.text;
               break;
            case WindowMouseEvent.const_51:
               showSuggestions(false);
               if(var_1293)
               ...
               break;
            case WindowKeyboardEvent.const_650:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1433 = _loc1_.stuffTypes;
            var_600 = _loc1_.boxTypes;
            var_599 = _loc1_.ribbonTypes;
            var_876 = var_1433[0];
            _boxIndex = var_600[0];
            var_199 = var_599[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_230.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_230 == null)
         {
            var_230 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_519 == null)
         {
            var_519 = createWindow("suggestion_list_item") as IWindowContainer;
            var_519.procedure = suggestionsEventHandler;
         }
         if(var_230 == null || var_519 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_230.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_519.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
