package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_navigator.getXmlWindow(this.var_1180));
      ...
      public function show() : void
      {
         ...
         var _loc2_:Rectangle = Util.getLocationRelativeTo(var_252.desktop,var_252.width,var_252.height);
         var_252.x = _loc2_.x;
         var_252.y = _loc2_.y;
