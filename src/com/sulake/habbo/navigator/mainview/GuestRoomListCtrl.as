package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_378:IScrollbarWindow;
      
      private var var_841:UserCountRenderer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         var_841 = new UserCountRenderer(_navigator);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         if(var_1230 != null)
         {
            _loc2_ = var_1230.tags[0];
            var_1230.color = getBgColor(_loc2_);
         }
         var_1230 = param1;
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         var_378 = IScrollbarWindow(var_19.findChildByName("scroller"));
      }
      
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         var _loc2_:WindowMouseEvent = WindowMouseEvent(param1);
         var _loc3_:int = Math.abs(var_1979 - _loc2_.stageX);
         var_1979 = _loc2_.stageX;
         var_1980 = _loc3_ > 2;
      }
      ...
      private function refreshFavouriteIcon(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         refreshRegion(param1,"favourite",_loc3_ && !_loc4_,method_10);
      }
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         _navigator.refreshButton(param1,"doormode_doorbell_small",param2.method_1 == RoomSettingsFlatInfo.const_151,null,0);
         _navigator.refreshButton(param1,"doormode_password_small",param2.method_1 == RoomSettingsFlatInfo.const_115,null,0);
         refreshRoomName(param1,param2);
         var_841.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc7_.ownerName != _navigator.sessionData.userName)
            {
               ...
               switch(_loc7_.method_1)
               {
                  case RoomSettingsFlatInfo.const_115:
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1237,true);
