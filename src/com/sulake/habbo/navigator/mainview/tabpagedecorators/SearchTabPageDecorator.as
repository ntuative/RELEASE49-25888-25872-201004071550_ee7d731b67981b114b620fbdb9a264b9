package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1539:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_222,Tabs.const_200,"-1",MainViewCtrl.const_715);
      }
      ...
      private function refreshSearchInfo(param1:IWindowContainer) : void
      {
         ...
         {
            _loc5_.visible = true;
            if(_navigator.data.guestRoomSearchResults.searchType == Tabs.const_299)
            {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1539 == null)
         {
            ...
            var_1539 = new TextSearchInputs(_navigator,false,_loc4_);
         ...
         {
            var_1539.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
