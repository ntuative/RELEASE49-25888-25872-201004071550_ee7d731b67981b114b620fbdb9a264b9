package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         var_335.addEventListener(TimerEvent.TIMER,onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(var_335)
         {
            var_335.removeEventListener(TimerEvent.TIMER,onDisplayTimer);
            var_335.reset();
            var_335 = null;
         }
         if(var_296)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_48 == null)
         {
            var_48 = IWindowContainer(_navigator.getXmlWindow(var_1180));
            var_48.visible = false;
         ...
         var_48.x = _loc2_.x + var_1741 + param1.width;
