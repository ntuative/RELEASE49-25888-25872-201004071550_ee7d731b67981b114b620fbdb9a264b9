package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_770:int = 32;
      
      private static const const_1087:int = 8;
      
      public static const const_354:int = 10;
      
      private static const const_1088:int = 40;
      ...
      private var var_2042:Dictionary;
      
      private var var_857:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_857 = new ThumbnailImageConfigurations(_navigator);
         initScreenLocsByPositions();
      }
      
      public function method_4(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         var _loc7_:* = null;
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_857.getImage(ThumbnailEditorModel.const_33,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1086,_loc4_.y + const_1088 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2042[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_857.getImage(ThumbnailEditorModel.const_37,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_857.getImage(ThumbnailEditorModel.const_37,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_857.getImage(ThumbnailEditorModel.const_53,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_770 / 2);
         return new Point(param1 * const_770 + _loc3_,param2 * const_1087);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         var _loc4_:* = null;
         _loc3_ = 0;
         while(_loc3_ <= const_354)
         {
            var_1045[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1045[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_354)
         {
            if(false)
            {
               refreshObj(param1,var_1045[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1263 == null)
         {
            var_1263 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1263,var_1263.rect,new Point(0,0),null,null,true);
      }
   }
}
