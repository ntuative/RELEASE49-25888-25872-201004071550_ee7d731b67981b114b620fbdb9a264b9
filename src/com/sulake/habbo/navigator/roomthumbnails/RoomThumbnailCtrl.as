package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1551,this._model.mode != ThumbnailEditorModel.const_53);
         setEnabled(var_1550,this._model.mode != ThumbnailEditorModel.const_33);
      }
      ...
      {
         this._navigator.thumbRenderer.method_4(IWindowContainer(_window.findChildByName("picframe")),_model.data,false);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1551 = IButtonWindow(find("top_tab"));
         var_1550 = IButtonWindow(find("obj_tab"));
         var_2134 = IWindowContainer(find("tile_grid"));
         var_2135 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1551,onTopTabButton);
         Util.setProcDirectly(var_1550,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2134;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_354)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_2135;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_59,HabboWindowStyle.const_40,HabboWindowParam.const_69,new Rectangle(0,0,param1.width,66)));
