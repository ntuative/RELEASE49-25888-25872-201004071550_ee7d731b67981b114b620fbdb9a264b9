package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_835:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_498 = new Timer(100);
         var_498.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_38 = new Array();
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_50,104,"a"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_50,94,"b"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_50,36,"c"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_50,84,"d"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_50,80,"e"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_50,80,"f"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_50,416,"i"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_50,320,"j"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_50,448,"k"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_50,352,"l"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_50,384,"m"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_50,372,"n"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,80,"g"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,74,"h"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,416,"o"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,352,"p"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,304,"q"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,336,"r"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,748,"u"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_55,438,"v"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_71,540,"t"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_71,512,"w"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_71,396,"x"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_71,440,"y"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_71,456,"z"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_71,208,"0"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_1017 = new TextFieldManager(_navigator,ITextFieldWindow(var_19.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc2_:Rectangle = Util.getLocationRelativeTo(var_19.desktop,var_19.width,var_19.height);
         var_19.x = _loc2_.x;
         var_19.y = _loc2_.y;
      }
      
      private function method_6(param1:IWindowContainer, param2:RoomLayout, param3:Boolean) : void
      {
      ...
      public function dispose() : void
      {
         if(var_498)
         {
            var_498.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_498.reset();
            var_498 = null;
         }
      }
      ...
      {
         var_1017.goBackToInitialState();
         var_1017.input.textBackgroundColor = 4294967295;
         var_835 = var_38[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_59,HabboWindowStyle.const_40,HabboWindowParam.const_69,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1017.getText();
      ...
      {
         var _loc1_:Boolean = var_1017.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_835.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1212 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1212 = true;
            _loc3_.y = 1;
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         while(_loc4_ < var_38.length)
         {
            ...
            if(isAllowed(_loc7_))
            {
               ...
               method_6(_loc3_,var_38[_loc4_],_loc2_ % 2 == 0);
               _loc2_ = _loc2_ == 0 ? 1 : 0;
            }
            _loc4_++;
         }
