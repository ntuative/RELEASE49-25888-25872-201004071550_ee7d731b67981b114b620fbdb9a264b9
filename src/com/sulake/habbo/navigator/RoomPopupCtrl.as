package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1667 = new RoomThumbnailRenderer(param1);
         var_798 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_178,var_114.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_178.findChildByName("roomowner"));
         if(true)
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_178.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         var_798.refreshTags(_loc1_,var_114.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1667.method_4(_loc1_,var_114.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         if(var_178 == null)
         {
            var_178 = IWindowContainer(param1.findChildByName("details_container"));
         }
         var_178.visible = true;
         Util.hideChildren(var_178);
         refreshRoomName(var_178,var_114);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_178,!true ? getEventCtg(var_114.categoryId) : getRoomCtg(var_114.categoryId));
         refreshRoomDesc(var_178,var_114);
         refreshExtraCont();
         refreshInfo(var_178,"trading_allowed",var_114.allowTrading);
         refreshInfo(var_178,"doormode_doorbell",false);
         refreshInfo(var_178,"doormode_password",false);
         Util.moveChildrenToColumn(var_178,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         var_178.height = Util.getLowestPoint(var_178);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_222,Tabs.const_200,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
