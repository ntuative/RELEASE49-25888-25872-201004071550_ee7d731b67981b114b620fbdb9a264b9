package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_168,HabboToolbarIconEnum.EXITROOM);
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.method_1 == RoomSettingsData.const_151 && _navigator.sessionData.userName != _loc2_.data.ownerName)
            {
               _navigator.doorbell.show(_loc2_.data);
            }
            else if(_loc2_.data.method_1 == RoomSettingsData.const_115 && _navigator.sessionData.userName != _loc2_.data.ownerName)
            {
