package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2370:Dictionary;
      ...
      private var var_778:RoomCreateViewCtrl;
      
      private var var_1667:RoomThumbnailRenderer;
      
      private var var_190:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_555:RoomInfoViewCtrl;
      ...
      private var var_1023:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_555 = new RoomInfoViewCtrl(this);
         var_778 = new RoomCreateViewCtrl(this);
         var_1667 = new RoomThumbnailRenderer(this);
         var_1023 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_434 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_246.startSearch(Tabs.const_222,Tabs.const_299,param1);
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_190 != null)
         {
            var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_246.startSearch(Tabs.const_253,Tabs.const_226);
         var_434.getTab(Tabs.const_253).tabPageDecorator.tabSelected();
      }
