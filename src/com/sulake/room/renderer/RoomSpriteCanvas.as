package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_776:int = 50;
      ...
      private var var_2095:Number = -10000000;
      
      private var var_2098:Number = -10000000;
      
      private var var_2361:int = 0;
      
      private var var_518:RoomObjectCache;
      
      private var var_724:int;
      
      private var var_269:Sprite;
      
      private var var_1066:IRoomRenderingCanvasMouseListener = null;
      ...
      public function update() : void
      {
         if(var_1065 == 0)
         {
            checkMouseHits(var_1067.x,var_1067.y,MouseEvent.MOUSE_MOVE);
         }
         var_1065 = 0;
         ++var_1540;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_269 != null)
         {
            var_269.graphics.clear();
         }
         else
         {
            var_269 = new Sprite();
            var_269.name = "mask";
            _master.addChild(var_269);
         }
         var_269.graphics.beginFill(0);
         var_269.graphics.drawRect(0,0,param1,param2);
         var_724 = param1;
         var_723 = param2;
         var_54.graphics.clear();
         var_54.graphics.beginFill(var_2361);
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_724 != var_2094 || var_723 != var_2097)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         var_422.sortOn("z",0 | 0);
         if(_loc6_ < var_422.length)
         {
            var_422.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_422[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_874.push(_loc12_ - _loc2_);
         if(var_874.length == const_776)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_776)
            {
               _loc13_ += var_874[_loc14_];
               _loc14_++;
            }
            var_874 = [];
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_517.length)
            {
               cleanSprite(var_517[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_517 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_314 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = var_314.getKey(_loc1_);
            _loc3_ = var_314.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1066 != null)
                  {
                     var_1066.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1540,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_422.length)
         {
            return null;
         }
         return var_422[param1] as SortableSprite;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_516.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_516.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2095 || param2 != var_2098)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_516.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_516.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_517.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         if(_loc5_ == null)
         {
            var_518.removeObjectCache(param2);
            return 0;
         }
         var _loc6_:RoomObjectCacheItem = var_518.getObjectCache(param2);
