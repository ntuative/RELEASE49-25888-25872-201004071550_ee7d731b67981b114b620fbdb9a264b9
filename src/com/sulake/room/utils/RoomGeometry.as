package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_875:Number = 32;
      ...
      private var var_2362:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_84 = new Vector3d();
         var_1093 = new Vector3d();
         var_1586 = 1;
         var_1587 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1585 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_440 != param1 * var_1585)
         {
            var_440 = param1 * var_1585;
            ++var_76;
         }
      }
      ...
      {
         if(var_439 != param1 * var_1586)
         {
            var_439 = param1 * var_1586;
            ++var_76;
         }
      }
      ...
      {
         if(var_438 != param1 * var_1587)
         {
            var_438 = param1 * var_1587;
            ++var_76;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_437 != null)
         {
            ...
            var_437.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_437.add(_loc3_,_loc4_);
            ++var_76;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1093.assign(_loc22_);
         }
         else
         {
            var_1093.assign(_loc17_);
         }
         ++var_76;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_438;
         _loc2_.z *= var_440;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1093);
         if(_loc3_ < var_2362 || _loc3_ > var_2363)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_438;
            _loc2_.z *= var_440;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1093);
         }
      ...
      {
         return new Vector3d(0 * var_439,0 * var_438,0 * var_440);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_437 != null)
         {
            ...
            return var_437.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_439,0 * var_438,0 * var_440);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_84;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_439,param2.y * var_438,param2.z * var_440);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_439,param3.y * var_438,param3.z * var_440);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_439,param4.y * var_438,param4.z * var_440);
