package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1219:int = 0;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         _events.addEventListener(RoomContentLoadedEvent.const_448,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_680,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(var_31 == const_1219)
         {
            if(var_924 != null)
            {
               return false;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = var_442.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = var_442.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_42.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = var_537.indexOf(param1);
            if(_loc2_ >= 0)
            {
               var_537.splice(_loc2_,1);
            }
            if(false)
            {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = var_442.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = var_442.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
